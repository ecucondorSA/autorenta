-- ============================================================================
-- SUPABASE RLS POLICIES - CORRECTED based on actual table schemas
-- ============================================================================
...
-- 2. fgo_metrics - Restricted to admins
...
-- 4. monitoring_alerts - Admins only
...
-- 5. monitoring_performance_metrics - Admins only
...
-- 7. wallet_transaction_backups - Admins only
DROP POLICY IF EXISTS "wallet_backups_admin_only" ON public.wallet_transaction_backups;
CREATE POLICY "wallet_backups_admin_only"
...
-- 8. accounting_audit_log - Admins only
...
-- 9. accounting_period_balances - Admins only
...
-- 10. accounting_period_closures - Admins only
...
-- 11. accounting_provisions - Admins only
...
-- 12. accounting_revenue_recognition - Admins only
...
-- 13. driver_score_snapshots - System analytics, admins only
DROP POLICY IF EXISTS "driver_score_snapshots_admin_only" ON public.driver_score_snapshots;
CREATE POLICY "driver_score_snapshots_admin_only"
...
-- 17. accounting_accounts - Admins only
...
-- 18. accounting_chart_of_accounts - Admins only
