...
export function registerAuditResources(server: MCPServer, audit: AuditClient) {
  // Resource: Security Audit Summary
  server.registerResource(
    'autorenta://audit/security-summary',
    async () => {
  ...
  server.registerResource(
    'autorenta://audit/security-definer-functions',
    async () => {
...
`,
  ...
  server.registerResource(
    'autorenta://audit/schema-analysis',
    async () => {
