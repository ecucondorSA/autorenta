...
* fix: align BookingStatus enum with DB and fix validation script path ([d95ab0c](https://github.com/ecucondorSA/autorenta/commit/d95ab0c))
* fix: correct TikTok OAuth endpoint from /v2/oauth/authorize/ to /v2/auth/authorize/ ([e7a95b5](https://github.com/ecucondorSA/autorenta/commit/e7a95b5))
* fix: drop wallet_get_balance() overload + graceful unauthenticated handling ([5a83bbf](https://github.com/ecucondorSA/autorenta/commit/5a83bbf))
* fix: fix broken migration (wrong table/columns) + reload PostgREST schema cache ([6e32cea](https://github.com/ecucondorSA/autorenta/commit/6e32cea))
* fix: harden tiktok lead webhook upserts ([b370f78](https://github.com/ecucondorSA/autorenta/commit/b370f78))
* fix: improve marketing content generation ([18170cb](https://github.com/ecucondorSA/autorenta/commit/18170cb))
* fix: kill zombie SW — explicit SPA routes + nuclear recovery ([56d7b89](https://github.com/ecucondorSA/autorenta/commit/56d7b89))
* fix: make owners-landing route public for lead capture ([10a608f](https://github.com/ecucondorSA/autorenta/commit/10a608f))
* fix: migrate domain to autorentar.com, optimize assets & SEO metadata ([13061f6](https://github.com/ecucondorSA/autorenta/commit/13061f6))
* fix: model search not filtering — searchQuery was plain string, not signal ([e6716f7](https://github.com/ecucondorSA/autorenta/commit/e6716f7))
* fix: ngsw assetGroup pattern intercepting wallet RPC + _redirects catch-all ([262d0ea](https://github.com/ecucondorSA/autorenta/commit/262d0ea))
* fix: ngsw-config wrong Supabase project + TS errors in bookings-hub ([73f2bdf](https://github.com/ecucondorSA/autorenta/commit/73f2bdf))
* fix: nuclear remove of evolution-api submodule to ensure build passes ([aed1ca3](https://github.com/ecucondorSA/autorenta/commit/aed1ca3))
* fix: production error prevention — 4-layer defense ([9d5b3dd](https://github.com/ecucondorSA/autorenta/commit/9d5b3dd))
* fix: regenerate database types from live Supabase schema ([33c9254](https://github.com/ecucondorSA/autorenta/commit/33c9254))
* fix: remove leftover console.log in beacon service ([44b5c8e](https://github.com/ecucondorSA/autorenta/commit/44b5c8e))
* fix: remove orphan submodule reference to fix deployment ([4ee2e1b](https://github.com/ecucondorSA/autorenta/commit/4ee2e1b))
* fix: replace /marketplace route with /cars/list across platform ([f903233](https://github.com/ecucondorSA/autorenta/commit/f903233))
* fix: resolve all build errors (imports, types, templates) ([a8d3d13](https://github.com/ecucondorSA/autorenta/commit/a8d3d13))
* fix: resolve build errors in booking-checkout and subscription service ([8dc0c9c](https://github.com/ecucondorSA/autorenta/commit/8dc0c9c))
* fix: resolve lint warnings ([36c9cab](https://github.com/ecucondorSA/autorenta/commit/36c9cab))
* fix: resolve typescript and template errors blocking production build ([654ee5c](https://github.com/ecucondorSA/autorenta/commit/654ee5c))
* fix: restore missing service imports in checkout page to resolve unknown type errors ([70a8f2e](https://github.com/ecucondorSA/autorenta/commit/70a8f2e))
* fix: stop create-cloudflare-config.js from overwriting _redirects ([e68e687](https://github.com/ecucondorSA/autorenta/commit/e68e687))
* fix: verification page - email-only Level 1, disable phone, fix session ([d8421b0](https://github.com/ecucondorSA/autorenta/commit/d8421b0))
* fix: verification page stuck at 0% - rewrite to linear flow with session refresh ([7b8a68f](https://github.com/ecucondorSA/autorenta/commit/7b8a68f))
* fix(auth): add SPA fallback in 404.html for OAuth callback and stale deploys ([e37c785](https://github.com/ecucondorSA/autorenta/commit/e37c785))
* fix(auth): break infinite redirect loop on /profile when session is stale ([376947a](https://github.com/ecucondorSA/autorenta/commit/376947a))
* fix(auth): eliminate redirect loop from ProfileService auth throws ([9960c8b](https://github.com/ecucondorSA/autorenta/commit/9960c8b))
* fix(auth): make admin checks use is_admin rpc ([765c11e](https://github.com/ecucondorSA/autorenta/commit/765c11e))
* fix(bookings): fix type errors in bookings hub (deposit_status, money pipe) ([b5b09b5](https://github.com/ecucondorSA/autorenta/commit/b5b09b5))
* fix(build): resolve all TypeScript and postbuild errors ([c3f470b](https://github.com/ecucondorSA/autorenta/commit/c3f470b))
* fix(build): resolve remaining BookingUiStatus type mismatches ([54d0dd0](https://github.com/ecucondorSA/autorenta/commit/54d0dd0))
* fix(build): use declare for google namespace instead of @types/google.maps ([515b9c7](https://github.com/ecucondorSA/autorenta/commit/515b9c7))
* fix(cars): align CarStatus type with DB enum and harden status updates ([49313a0](https://github.com/ecucondorSA/autorenta/commit/49313a0))
* fix(cars): complete car status alignment and pending car UX ([6405035](https://github.com/ecucondorSA/autorenta/commit/6405035))
* fix(cars): pending only for identity verification ([64abdc5](https://github.com/ecucondorSA/autorenta/commit/64abdc5))
* fix(ci): add wallet_initiate_deposit to guardrails baseline ([0127fae](https://github.com/ecucondorSA/autorenta/commit/0127fae))
* fix(ci): auto-create marketing bucket if missing ([a8e96b6](https://github.com/ecucondorSA/autorenta/commit/a8e96b6))
* fix(ci): correct Supabase pooler URL in RPC contract check ([5548d18](https://github.com/ecucondorSA/autorenta/commit/5548d18))
* fix(ci): disable husky hooks in semantic-release workflow ([d7e8a18](https://github.com/ecucondorSA/autorenta/commit/d7e8a18))
* fix(ci): disable web security to allow unsplash images ([e679138](https://github.com/ecucondorSA/autorenta/commit/e679138))
* fix(ci): fix quality gates, rpc contract check, and semantic release ([8cfaa03](https://github.com/ecucondorSA/autorenta/commit/8cfaa03))
* fix(ci): fix remaining CI failures — submodules and bun install ([f3fc791](https://github.com/ecucondorSA/autorenta/commit/f3fc791))
* fix(ci): fix skipped smoke-tests and empty deployment_id ([d9397a1](https://github.com/ecucondorSA/autorenta/commit/d9397a1))
* fix(ci): force push of root install fix ([df354bf](https://github.com/ecucondorSA/autorenta/commit/df354bf))
* fix(ci): replace bun with pnpm exec tsx in pre-commit hook ([e29724b](https://github.com/ecucondorSA/autorenta/commit/e29724b))
* fix(ci): robust video render workflow with upload script ([3aba264](https://github.com/ecucondorSA/autorenta/commit/3aba264))
* fix(ci): use swangle and disable gpu for remotion stability ([822b2f0](https://github.com/ecucondorSA/autorenta/commit/822b2f0))
* fix(db): add #variable_conflict use_column to wallet_get_balance ([d8dd281](https://github.com/ecucondorSA/autorenta/commit/d8dd281)), closes [#variable_conflict](https://github.com/ecucondorSA/autorenta/issues/variable_conflict) [#variable_conflict](https://github.com/ecucondorSA/autorenta/issues/variable_conflict)
* fix(db): add missing booking_status enum values ([bbcaab0](https://github.com/ecucondorSA/autorenta/commit/bbcaab0))
* fix(db): add pending car status and marketplace policies ([06a4cd1](https://github.com/ecucondorSA/autorenta/commit/06a4cd1))
* fix(db): enforce active cars require id_verified ([6c8894a](https://github.com/ecucondorSA/autorenta/commit/6c8894a))
* fix(db): recreate v_wallet_history view safely ([7e7ac26](https://github.com/ecucondorSA/autorenta/commit/7e7ac26))
* fix(db): resolve ambiguous "user_id" in wallet_get_balance (PG 42702) ([368bcca](https://github.com/ecucondorSA/autorenta/commit/368bcca))
* fix(edge): ensure CORS headers on validate-photo-quality errors ([baeafc7](https://github.com/ecucondorSA/autorenta/commit/baeafc7))
* fix(geo): remove lint warnings in map providers ([c662c9b](https://github.com/ecucondorSA/autorenta/commit/c662c9b))
* fix(lint): resolve unused variables and import order warnings ([185ed54](https://github.com/ecucondorSA/autorenta/commit/185ed54))
* fix(map): add null check for layer toggle event to prevent runtime errors ([43be6d3](https://github.com/ecucondorSA/autorenta/commit/43be6d3))
* fix(marketplace): adjust layout structure and add single result detection ([f303bf7](https://github.com/ecucondorSA/autorenta/commit/f303bf7))
* fix(mcp): prevent patchright monitor crash ([124e47f](https://github.com/ecucondorSA/autorenta/commit/124e47f))
* fix(owners-landing): enable immediate car brand/model selection on focus ([f9aba8c](https://github.com/ecucondorSA/autorenta/commit/f9aba8c))
* fix(scripts): harden audit rpc failures ([f2ded7e](https://github.com/ecucondorSA/autorenta/commit/f2ded7e))
* fix(security): add authentication to AI Vision Service handlers ([b900c01](https://github.com/ecucondorSA/autorenta/commit/b900c01))
* fix(security): harden enum types and add auth check to money-out ([704eac5](https://github.com/ecucondorSA/autorenta/commit/704eac5))
* fix(security): lock down get_enum_values rpc ([3e84b34](https://github.com/ecucondorSA/autorenta/commit/3e84b34))
* fix(security): lock down rls audit helper functions ([846cf81](https://github.com/ecucondorSA/autorenta/commit/846cf81))
* fix(subscriptions): remove invalid 'upgraded' from SubscriptionStatus enum ([311a854](https://github.com/ecucondorSA/autorenta/commit/311a854))
* fix(types): update BookingStatus enum definition to include new DB values ([db1d5a2](https://github.com/ecucondorSA/autorenta/commit/db1d5a2))
* fix(ui): evitar header duplicado en perfil ([cd0ef8c](https://github.com/ecucondorSA/autorenta/commit/cd0ef8c))
* fix(ui): polish marketplace + profile navigation ([d91f57c](https://github.com/ecucondorSA/autorenta/commit/d91f57c))
* fix(verification): align id_verified + remove profile kyc ([2c95c29](https://github.com/ecucondorSA/autorenta/commit/2c95c29))
* fix(video): add remotion.config.ts to increase render timeout to 2m ([30118f3](https://github.com/ecucondorSA/autorenta/commit/30118f3))
* fix(video): remove invalid Config.setLogLevel call ([003573d](https://github.com/ecucondorSA/autorenta/commit/003573d))
* fix(wallet): enhance wallet transfer with proper error handling and logging ([412d6e7](https://github.com/ecucondorSA/autorenta/commit/412d6e7))
* fix(web): harden publish + nested route asset loading ([23048b2](https://github.com/ecucondorSA/autorenta/commit/23048b2))
* refactor: apply senior performance and stability optimizations ([0abde5a](https://github.com/ecucondorSA/autorenta/commit/0abde5a))
* refactor: comprehensive code audit - type safety, logging, profile UX, auth hardening ([40083c6](https://github.com/ecucondorSA/autorenta/commit/40083c6))
* refactor: consolidate email functions into email-service ([4576a26](https://github.com/ecucondorSA/autorenta/commit/4576a26))
* refactor: eliminate console.log in prod code and replace alert() with toast ([abe599a](https://github.com/ecucondorSA/autorenta/commit/abe599a))
* refactor: enforce strict typing by removing any in payment logic ([2cd3320](https://github.com/ecucondorSA/autorenta/commit/2cd3320))
* refactor: migrate to consolidated ai-vision-service ([6b6afd6](https://github.com/ecucondorSA/autorenta/commit/6b6afd6))
* refactor: remove explicit any usages and improve type safety ([8e4911a](https://github.com/ecucondorSA/autorenta/commit/8e4911a))
* refactor: replace console.log with LoggerService in beacon and pricing services ([b392627](https://github.com/ecucondorSA/autorenta/commit/b392627))
* refactor(bookings): extract operational dashboard & cleanup hub architecture ([2f944b7](https://github.com/ecucondorSA/autorenta/commit/2f944b7))
* refactor(cars): centralize pricing logic in service ([84a6723](https://github.com/ecucondorSA/autorenta/commit/84a6723))
* refactor(cars): remove supabase leak in publish form ([df4aca9](https://github.com/ecucondorSA/autorenta/commit/df4aca9))
* refactor(cars): split car card view from pricing container ([994762a](https://github.com/ecucondorSA/autorenta/commit/994762a))
* refactor(pricing): use LoggerService instead of console methods ([beb77b5](https://github.com/ecucondorSA/autorenta/commit/beb77b5))
* refactor(ui): implement premium skeleton loaders in booking flow ([da47673](https://github.com/ecucondorSA/autorenta/commit/da47673))
* refactor(ui): upgrade marketplace grid and car card to senior responsive design ([09844ba](https://github.com/ecucondorSA/autorenta/commit/09844ba))
* chore: add app assets and marketing images ([5abd174](https://github.com/ecucondorSA/autorenta/commit/5abd174))
* chore: add TikTok verification file ([78ce958](https://github.com/ecucondorSA/autorenta/commit/78ce958))
* chore: add tools and gitignore for large/sensitive files ([3f354c5](https://github.com/ecucondorSA/autorenta/commit/3f354c5))
* chore: cleanup duplicate/unused edge functions ([a8c9f0e](https://github.com/ecucondorSA/autorenta/commit/a8c9f0e))
* chore: cleanup unused imports and git submodules ([ffaf565](https://github.com/ecucondorSA/autorenta/commit/ffaf565))
* chore: commit all changes ([cb5cdd9](https://github.com/ecucondorSA/autorenta/commit/cb5cdd9))
* chore: gitignore debug screenshots, tool artifacts, mcp-server dist ([2ec67e6](https://github.com/ecucondorSA/autorenta/commit/2ec67e6))
* chore: move cron jobs to GitHub Actions ([e0838e7](https://github.com/ecucondorSA/autorenta/commit/e0838e7))
* chore: remove duplicate edge functions ([135206b](https://github.com/ecucondorSA/autorenta/commit/135206b))
* chore: remove evolution-api submodule reference ([d710edf](https://github.com/ecucondorSA/autorenta/commit/d710edf))
* chore: remove outdated docs and e2e reports ([2e14b13](https://github.com/ecucondorSA/autorenta/commit/2e14b13))
* chore: save progress ([de79426](https://github.com/ecucondorSA/autorenta/commit/de79426))
* chore: save workspace state (package updates & video-studio) ([d9ea995](https://github.com/ecucondorSA/autorenta/commit/d9ea995))
* chore(db): add admin helpers for RLS ([b450aa4](https://github.com/ecucondorSA/autorenta/commit/b450aa4))
* chore(guardrails): baseline rpc overrides ([d943b16](https://github.com/ecucondorSA/autorenta/commit/d943b16))
* chore(lint): eliminate all 700 ESLint warnings ([a990eb5](https://github.com/ecucondorSA/autorenta/commit/a990eb5))
* chore(repo): deep gitignore update and build fixes ([fb79bf7](https://github.com/ecucondorSA/autorenta/commit/fb79bf7))
* chore(types): regenerate DB types + remove drift ([7b37ae9](https://github.com/ecucondorSA/autorenta/commit/7b37ae9))
* feat: add ai-vision-service consolidated endpoint ([11156a9](https://github.com/ecucondorSA/autorenta/commit/11156a9))
* feat: add finanzas feature; update mcp libs and marketing edge function ([dfb5226](https://github.com/ecucondorSA/autorenta/commit/dfb5226))
* feat: add GitHub Actions for cron jobs ([1926d79](https://github.com/ecucondorSA/autorenta/commit/1926d79))
* feat: add Nano Banana illustrations, PWA shortcuts, category icons & UI integration ([5cabe66](https://github.com/ecucondorSA/autorenta/commit/5cabe66))
* feat: automated lead welcome via whatsapp and tiktok pixel tracking ([00214ce](https://github.com/ecucondorSA/autorenta/commit/00214ce))
* feat: bookings-hub 100% professional redesign ([bb24ab4](https://github.com/ecucondorSA/autorenta/commit/bb24ab4))
* feat: complete bookings hub v2 implementation ([d345976](https://github.com/ecucondorSA/autorenta/commit/d345976))
* feat: grey overlay for unverified owner cars in marketplace and map ([bc9882c](https://github.com/ecucondorSA/autorenta/commit/bc9882c))
* feat: implement web lead capture form and update hybrid leadgen webhook ([c92f6a3](https://github.com/ecucondorSA/autorenta/commit/c92f6a3))
* feat: Project Vellum Phase 1-3 — Booking Experience Overhaul ([21ea089](https://github.com/ecucondorSA/autorenta/commit/21ea089))
* feat: updates marketplace features ([fcf2d1d](https://github.com/ecucondorSA/autorenta/commit/fcf2d1d))
* feat(audit): add automated RLS coverage audit ([6f8bdd8](https://github.com/ecucondorSA/autorenta/commit/6f8bdd8))
* feat(bookings): add asset dashboard mode with dynamic stepper and mini-map ([4d9be97](https://github.com/ecucondorSA/autorenta/commit/4d9be97))
* feat(bookings): add operational dashboard with stepper, active rental card, and contextual actions ([4b13035](https://github.com/ecucondorSA/autorenta/commit/4b13035))
* feat(bookings): add owner mirror for asset management dashboard ([8aa2d11](https://github.com/ecucondorSA/autorenta/commit/8aa2d11))
* feat(bookings): hub v2 - operational dashboard and focus card improvements ([7b831e1](https://github.com/ecucondorSA/autorenta/commit/7b831e1))
* feat(bookings): redesign hub as "Gestión de Renta Activa" with mockup layout ([913ff78](https://github.com/ecucondorSA/autorenta/commit/913ff78))
* feat(cars): add updateCar method, improve publish error handling, and enhance car card logic ([b41f0b5](https://github.com/ecucondorSA/autorenta/commit/b41f0b5))
* feat(cars): improve auth error handling in publish flow and update redirects ([8f36979](https://github.com/ecucondorSA/autorenta/commit/8f36979))
* feat(cars): show pending cars for owners in map and add eruda for mobile debugging ([4ac439f](https://github.com/ecucondorSA/autorenta/commit/4ac439f))
* feat(ci): add preview-first deploy, auto-rollback, dynamic Sentry, and GitHub environment ([4ce7075](https://github.com/ecucondorSA/autorenta/commit/4ce7075))
* feat(ci): add quality gates workflow ([5ba3b22](https://github.com/ecucondorSA/autorenta/commit/5ba3b22))
* feat(ci): update workflow to use matrix strategy for simultaneous posting ([e2e3322](https://github.com/ecucondorSA/autorenta/commit/e2e3322))
* feat(core): update RLS for pending cars and enhance mobile menu navigation ([f27bc66](https://github.com/ecucondorSA/autorenta/commit/f27bc66))
* feat(edge-functions): add reusable auth helpers ([dcd8953](https://github.com/ecucondorSA/autorenta/commit/dcd8953))
* feat(infra): unified services architecture + video rendering pipeline ([24fd52e](https://github.com/ecucondorSA/autorenta/commit/24fd52e))
* feat(maps): add dual map strategy (Mapbox + Google Maps fallback) - 70% complete ([782d5bf](https://github.com/ecucondorSA/autorenta/commit/782d5bf))
* feat(marketing): configure tiktok automation and add /ganar landing page ([f1e379c](https://github.com/ecucondorSA/autorenta/commit/f1e379c))
* feat(ui): add calendar menu item to sidebar ([75198ea](https://github.com/ecucondorSA/autorenta/commit/75198ea))
* feat(ui): add security center to sidebar ([a5a3c91](https://github.com/ecucondorSA/autorenta/commit/a5a3c91))
* feat(ui): replace ion-spinner with skeleton loaders for better UX ([7862185](https://github.com/ecucondorSA/autorenta/commit/7862185))
* feat(ui): unify profile menu nav model ([cadb61d](https://github.com/ecucondorSA/autorenta/commit/cadb61d))
* feat(validation): add enum sync validation pre-commit hook ([e78a974](https://github.com/ecucondorSA/autorenta/commit/e78a974))
* feat(video): add CarPromoV2 with cinematic motion ([427d35e](https://github.com/ecucondorSA/autorenta/commit/427d35e))
* docs: add AGENTS-2.md with advanced platform hardening rules ([3d8178d](https://github.com/ecucondorSA/autorenta/commit/3d8178d))
* docs: add Claude in Chrome setup, shortcuts, and proactive suggestions to CLAUDE.md ([2a49145](https://github.com/ecucondorSA/autorenta/commit/2a49145))
* docs: add hardening rules for supabase leaks ([2b38c28](https://github.com/ecucondorSA/autorenta/commit/2b38c28))
* docs: add MercadoPago architecture documentation ([8fe6403](https://github.com/ecucondorSA/autorenta/commit/8fe6403))
* docs: codify two-plane hardening and car pending policy ([9ef5da2](https://github.com/ecucondorSA/autorenta/commit/9ef5da2))
* docs: fix supabase rpc schema guidance ([f41f10e](https://github.com/ecucondorSA/autorenta/commit/f41f10e))
* docs: update model references from Opus 4.5 to Opus 4.6 ([5ed0a4f](https://github.com/ecucondorSA/autorenta/commit/5ed0a4f))
* docs(agents): add 10/10 hardening rules ([6b43fef](https://github.com/ecucondorSA/autorenta/commit/6b43fef))
* docs(agents): add auth-context rule + senior prompt template ([addc5b9](https://github.com/ecucondorSA/autorenta/commit/addc5b9))
* docs(agents): add drift checklist + prompt template ([fda3bb2](https://github.com/ecucondorSA/autorenta/commit/fda3bb2))
* docs(agents): reinforce two-plane + schema validation ([61dbbbd](https://github.com/ecucondorSA/autorenta/commit/61dbbbd))
* ci: add ai-vision-service and email-service to auto-deploy ([065fd1b](https://github.com/ecucondorSA/autorenta/commit/065fd1b))
* ci: fix quality gates path filtering ([3b389e2](https://github.com/ecucondorSA/autorenta/commit/3b389e2))
* ci: stop baselining migrations on deploy ([c16f490](https://github.com/ecucondorSA/autorenta/commit/c16f490))
* perf: optimize battery usage and reduce device heating ([e7155e7](https://github.com/ecucondorSA/autorenta/commit/e7155e7))
* perf(cars): batch dynamic pricing quotes ([8bdc527](https://github.com/ecucondorSA/autorenta/commit/8bdc527))
* perf(pricing): share realtime subscriptions ([865557f](https://github.com/ecucondorSA/autorenta/commit/865557f))
* style(marketplace): improve grid alignment for car cards ([8771a3e](https://github.com/ecucondorSA/autorenta/commit/8771a3e))
...
* docs: update inspection report with Session 8 findings ([57b6081](https://github.com/ecucondorSA/autorenta/commit/57b6081))
...
* fix(a11y): add alt text to more images ([4dfbf55](https://github.com/ecucondorSA/autorenta/commit/4dfbf55))
* feat(marketing): add Facebook outreach automation tools ([0712c3e](https://github.com/ecucondorSA/autorenta/commit/0712c3e))
* docs: update inspection findings with session 5 i18n fixes ([e527f13](https://github.com/ecucondorSA/autorenta/commit/e527f13))
...
* docs: update inspection report with Session 3 i18n fixes ([f5e901e](https://github.com/ecucondorSA/autorenta/commit/f5e901e))
* fix(i18n): additional Spanish accent corrections ([9b55f7d](https://github.com/ecucondorSA/autorenta/commit/9b55f7d))
* fix(i18n): Spanish accent corrections across core services and utilities ([0943576](https://github.com/ecucondorSA/autorenta/commit/0943576))
