-- ============================================================================
-- Insert sync logs for Binance rates update (CORRECTED)
-- Uses 'manual' instead of 'manual_update' to match constraint
-- ============================================================================
...
VALUES
  ('manual', 'BRL/USD', 0.188541, NULL, true, NULL, NULL),
  ('manual', 'USD/BRL', 5.304, NULL, true, NULL, NULL),
  ('manual', 'ARS/USD', 0.000680, NULL, true, NULL, NULL),
  ('manual', 'USD/ARS', 1471.60, NULL, true, NULL, NULL);
...
SELECT
  ...
  '' AS blank3,
  '➡️  Ready to run regional price comparison' AS next_step;
