...
class PlaywrightStreamingMCP {
  ...
  async ensureBrowser() {
    ...
    // Persistent profile directory for Binance session
    const userDataDir = '/home/edu/.binance-browser-profile';

    console.error('[MCP] Launching PERSISTENT browser for Binance P2P...');
