export type OrderStatus = 'detected' | 'extracting' | 'pending_transfer' | 'transferring' | 'awaiting_qr' | 'confirming' | 'marking_paid' | 'completed' | 'failed' | 'cancelled' | 'manual_review';
