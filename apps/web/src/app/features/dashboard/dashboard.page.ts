...
@Component({
  ...
  template: `
    <div
      class="min-h-screen bg-gradient-to-br from-surface-base via-surface-secondary/30 to-surface-base"
    >
      <!-- Hero Header -->
        ...
        <div class="max-w-7xl mx-auto px-6 py-12">
          <div class="flex items-center justify-between">
            <div>
              ...
              <p class="text-cta-text/80 text-lg">
                Aquí tienes un resumen de tu actividad en AutoRentAr
              </p>
            </div>
            ...
            <div class="bg-surface-raised rounded-3xl p-6 border border-border-subtle shadow-lg">
              <div class="flex items-center justify-between mb-6">
                <div class="flex items-center gap-3">
                  <div
                    class="w-10 h-10 rounded-2xl bg-gradient-to-br from-blue-500 to-blue-600 flex items-center justify-center shadow-lg"
                  >
                    <svg
                ...
                <button
                  class="px-4 py-2 text-sm font-medium bg-surface-secondary hover:bg-surface-hover text-text-primary rounded-xl transition-colors"
                >
          ...
          <div class="space-y-6">
            ...
            <div class="bg-surface-raised rounded-3xl p-6 border border-border-subtle shadow-lg">
              <div class="flex items-center gap-3 mb-4">
                <div
                  class="w-8 h-8 rounded-xl bg-gradient-to-br from-green-500 to-green-600 flex items-center justify-center"
                >
                  <svg
            ...
            <div class="bg-surface-raised rounded-3xl p-6 border border-border-subtle shadow-lg">
              ...
              <div class="space-y-3">
                <button
                  class="w-full flex items-center gap-3 p-3 rounded-2xl bg-gradient-to-r from-cta-default to-cta-hover text-white font-semibold hover:shadow-lg transition-all duration-200 hover:scale-[1.02] active:scale-[0.98]"
                >
                ...
                <button
                  class="w-full flex items-center gap-3 p-3 rounded-2xl bg-surface-secondary hover:bg-surface-hover text-text-primary font-medium transition-all duration-200 hover:shadow-md"
                >
                  <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path
                      stroke-linecap="round"
