    ...
    <div class="min-h-screen bg-gray-900 text-white p-6 grid grid-cols-1 lg:grid-cols-3 gap-6">
      ...
      <div class="lg:col-span-1 space-y-6">
        ...
        <div class="flex items-center justify-between">
          ...
          <span class="px-2 py-1 bg-green-900 text-green-400 text-xs rounded border border-green-700">SYSTEM ONLINE</span>
        </div>
              ...
              <div class="flex items-center justify-between p-3 bg-gray-900 rounded-lg">
                <div class="flex items-center gap-3">
                  <div class="w-8 h-8 rounded-full flex items-center justify-center" 
                       [ngClass]="device.is_active ? 'bg-blue-900 text-blue-400' : 'bg-red-900 text-red-400'">
      ...
      <div class="lg:col-span-2 relative bg-gray-800 rounded-xl overflow-hidden border border-gray-700 shadow-2xl">
        ...
        <div class="absolute bottom-6 right-6 flex flex-col gap-3">
          <button class="w-12 h-12 bg-gray-900 text-white rounded-full border border-gray-600 shadow-lg hover:bg-gray-800 flex items-center justify-center" title="Centrar en Vehículo">
            <i class="fas fa-crosshairs"></i>
          </button>
          <button class="w-12 h-12 bg-red-600 text-white rounded-full shadow-lg hover:bg-red-700 animate-pulse flex items-center justify-center" title="Emergencia">
