...
@Component({
  ...
  template: `
    <ion-content [fullscreen]="true" class="h-full bg-white">
      ...
      <section
        class="relative bg-[#050505] text-white min-h-[85vh] flex items-center overflow-hidden"
      >
        <!-- Abstract Tech Background -->
        <div class="absolute inset-0 z-0 opacity-40">
          <div
            class="absolute top-0 right-0 w-[800px] h-[800px] bg-accent-neon/10 rounded-full blur-[120px] -mr-40 -mt-40"
          ></div>
          <div
            class="absolute bottom-0 left-0 w-[600px] h-[600px] bg-accent-safety/10 rounded-full blur-[100px] -ml-20 -mb-20"
          ></div>
          <!-- Grid Overlay -->
          <div
        ...
        <div class="container mx-auto px-6 relative z-20 pt-20">
          <div class="max-w-4xl">
            <!-- Badge -->
            <div
              class="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-accent-neon/30 bg-accent-neon/10 text-accent-neon text-xs font-bold uppercase tracking-widest mb-8 animate-fade-in-up"
            >
            ...
            <!-- Headline -->
            <h1
              class="text-5xl sm:text-7xl md:text-8xl font-black tracking-tight leading-[0.9] mb-8 animate-fade-in-up delay-100"
            >
              Transformá tu auto <br />
              en un
              <span
                class="text-transparent bg-clip-text bg-gradient-to-r from-accent-neon to-emerald-400"
                >ACTIVO.</span
              >
            </h1>
            ...
            <!-- Subhead -->
            <p
              class="text-xl sm:text-2xl text-gray-400 font-medium max-w-2xl mb-10 leading-relaxed animate-fade-in-up delay-200"
            >
              Tu auto puede pagarse solo. Unite a la red de movilidad descentralizada más segura de
              Argentina.
            </p>
            ...
            <div
              class="mt-16 pt-8 border-t border-white/10 flex flex-wrap gap-8 md:gap-16 text-sm font-semibold text-gray-400 animate-fade-in-up delay-500"
            >
              <div class="flex items-center gap-3">
                <div
                  class="w-10 h-10 rounded-full bg-accent-safety/20 flex items-center justify-center text-accent-safety"
                >
                  <ion-icon name="shield-checkmark" class="text-xl"></ion-icon>
                </div>
                <span
                  >Seguro Todo Riesgo<br /><span class="text-white">Sura / Rivadavia</span></span
                >
              </div>
              <div class="flex items-center gap-3">
                <div
                  class="w-10 h-10 rounded-full bg-accent-voltage/20 flex items-center justify-center text-accent-voltage"
                >
                  <ion-icon name="scan" class="text-xl"></ion-icon>
                </div>
                <span
                  >Identidad Validada<br /><span class="text-white">Biometría Facial</span></span
                >
              </div>
              <div class="flex items-center gap-3">
                <div
        ...
        <div class="container mx-auto px-6">
          <div class="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
            <div class="lg:col-span-5">
              <span
                class="text-accent-neon-dark font-black tracking-widest text-sm uppercase mb-4 block"
                >Simulador de Negocio</span
              >
              ...
              <p class="text-xl text-gray-500 mb-8 leading-relaxed">
                Dejá de ver tu auto como un gasto. Empezá a verlo como un negocio. Los vehículos
                activos en plataforma cubren el 100% de sus costos fijos.
              </p>
              ...
              <div class="bg-surface-secondary p-6 rounded-2xl border border-gray-100">
                ...
                <p class="text-sm font-medium text-gray-600">
                  Tiempo promedio para recuperar el valor total del auto alquilándolo full-time.
                </p>
              </div>
            </div>
            ...
            <div class="lg:col-span-7">
              <div
                class="bg-white rounded-3xl shadow-2xl shadow-gray-200/50 p-2 border border-gray-100 transform hover:-translate-y-2 transition-transform duration-500"
              >
        ...
        <div class="container mx-auto px-6">
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-12">
            ...
            <div class="relative group">
              <div
                class="absolute -top-10 -left-6 text-[180px] font-black text-gray-200/50 select-none z-0 group-hover:text-accent-neon/20 transition-colors"
              >
                1
              </div>
              <div class="relative z-10 pt-10">
                <h3
                  class="text-2xl font-bold mb-4 text-black group-hover:text-accent-neon-dark transition-colors"
                >
                  Digitalizá tu Activo
                </h3>
                <p class="text-gray-600 leading-relaxed text-lg">
                  Cargá fotos y definí tus reglas. Nuestra IA sugiere el precio óptimo para
                  maximizar ocupación.
                </p>
              </div>
            </div>
            ...
            <div class="relative group">
              ...
              <div class="relative z-10 pt-10">
                ...
                <p class="text-gray-600 leading-relaxed text-lg">
                  Recibí pedidos de conductores verificados. Vos tenés el control total: aceptá solo
                  lo que te cierre.
                </p>
              </div>
            </div>
            ...
            <div class="relative group">
              ...
              <div class="relative z-10 pt-10">
                ...
                <p class="text-gray-600 leading-relaxed text-lg">
                  El dinero se libera automáticamente al finalizar el viaje. Directo a tu cuenta,
                  sin vueltas.
                </p>
              </div>
            </div>
      ...
      <section class="py-24 bg-accent-safety relative overflow-hidden text-white">
        <div
          class="absolute top-0 right-0 w-full h-full bg-[url('assets/images/pattern-grid.svg')] opacity-10"
        ></div>
        ...
        <div class="container mx-auto px-6 relative z-10">
          <div class="flex flex-col md:flex-row gap-16 items-center">
            <div class="flex-1">
              <div
                class="inline-flex items-center gap-2 px-4 py-2 bg-white/10 rounded-full backdrop-blur-sm border border-white/20 mb-8"
              >
              ...
              <p class="text-xl text-blue-100/90 leading-relaxed mb-10 max-w-xl">
                Nuestra tecnología de prevención de fraude y alianzas con aseguradoras líderes
                protegen tu capital 24/7.
              </p>

              <ul class="space-y-6">
                <li
                  class="flex items-center gap-4 bg-white/5 p-4 rounded-2xl border border-white/10 hover:bg-white/10 transition-colors"
                >
                  <div
                    class="w-12 h-12 rounded-full bg-accent-neon flex items-center justify-center shrink-0 shadow-lg shadow-accent-neon/20"
                  >
                  ...
                  <div>
                    ...
                    <p class="text-sm text-blue-100">
                      Daños, robo y responsabilidad civil hasta $50M.
                    </p>
                  </div>
                </li>
                <li
                ...
                >
                  ...
                  <div>
                    ...
                    <p class="text-sm text-blue-100">
                      IA detecta comportamientos de riesgo antes del alquiler.
                    </p>
                  </div>
                </li>
              </ul>
            ...
            <div class="flex-1 w-full relative">
              ...
              <div
                class="aspect-square rounded-[3rem] bg-gradient-to-tr from-white/10 to-white/5 backdrop-blur-2xl border border-white/20 flex items-center justify-center relative shadow-2xl"
              >
                ...
                <!-- Decorative Badge -->
                <div
                  class="absolute -bottom-6 -right-6 bg-accent-neon text-black p-6 rounded-2xl shadow-xl transform rotate-6"
                >
                  <span class="block text-xs font-bold uppercase tracking-wider opacity-70"
                    >Soporte</span
                  >
        ...
        <div class="container mx-auto px-6">
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            @for (testimonial of testimonials; track testimonial.id) {
              <div
                class="group bg-surface-secondary rounded-[2rem] p-8 hover:bg-black hover:text-white transition-all duration-300 cursor-default"
              >
                <div class="flex items-center gap-4 mb-6">
                  ...
                  <div>
                    ...
                    <p class="text-sm text-gray-500 group-hover:text-gray-400">
                      {{ testimonial.location }}
                    </p>
                  </div>
                </div>
                <p
                  class="text-lg font-medium leading-relaxed mb-8 text-gray-600 group-hover:text-gray-300"
                >
                  "{{ testimonial.quote }}"
                </p>
                <div
                  class="pt-6 border-t border-gray-200 group-hover:border-gray-800 flex justify-between items-center"
                >
                  <span class="text-xs font-bold uppercase tracking-widest text-gray-400"
                    >Ganancia Mes</span
                  >
                  <span
                    class="text-xl font-black text-accent-neon-dark group-hover:text-accent-neon"
                    >$ {{ testimonial.earnings | number }}</span
                  >
                </div>
              </div>
            }
      ...
      <section class="py-32 bg-[#050505] text-center relative overflow-hidden">
        ...
        <div
          class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-accent-neon/20 rounded-full blur-[150px]"
        ></div>
  ...
  testimonials = [
    {
      ...
      quote:
        'Era escéptico al principio, pero el sistema de verificación me dio seguridad. Hoy el auto paga sus propios gastos y me deja ganancia.',
      earnings: 420000,
    },
    {
      id: 2,
      ...
      avatar: 'assets/images/default-avatar.svg',
      quote:
        'Viajo mucho por trabajo y el auto quedaba juntando polvo. Ahora cada vez que viajo, el auto trabaja. Es una ecuación perfecta.',
      earnings: 280000,
    },
    {
      id: 3,
      ...
      avatar: 'assets/images/default-avatar.svg',
      quote:
        'Compré un segundo auto como inversión para AutoRenta. El retorno es superior a un alquiler inmobiliario tradicional.',
      earnings: 380000,
    },
  ];
