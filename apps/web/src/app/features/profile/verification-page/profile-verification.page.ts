    ...
    <div class="min-h-screen bg-surface-base">
              ...
              <div class="relative">
                <svg class="w-16 h-16 transform -rotate-90">
                  ...
                  <circle
                    ...
                    [class]="
                      progressPercentage() === 100 ? 'stroke-success-500' : 'stroke-cta-default'
                    "
      ...
      <main class="max-w-3xl mx-auto px-4 sm:px-6 py-6 sm:py-8 pb-24">
        ...
        @if (verificationReason()) {
          <div class="mb-6 p-4 rounded-2xl bg-warning-50 border border-warning-200 animate-fade-in">
            <div class="flex gap-4">
              <div
                class="flex-shrink-0 w-10 h-10 rounded-full bg-warning-100 flex items-center justify-center"
              >
                <svg
        ...
        <div class="hidden sm:block mb-8">
          <div class="flex items-center justify-between relative">
            ...
            <div class="relative z-10 flex flex-col items-center">
              ...
              <span class="mt-2 text-xs font-medium" [class]="getStepLabelClass(2)"
                >Documentos</span
              >
            </div>
        ...
        <div class="space-y-4">
              ...
              <div class="flex-1 min-w-0">
                ...
                <div class="mt-3 flex items-center gap-3">
                  <div class="flex items-center gap-1.5">
                    ...
                    <span
                      class="text-xs"
                      [class]="isEmailVerified() ? 'text-success-600' : 'text-text-muted'"
                      >Email</span
                    >
                  </div>
                  <div class="flex items-center gap-1.5">
                    ...
                    <span
                      class="text-xs"
                      [class]="isPhoneVerified() ? 'text-success-600' : 'text-text-muted'"
                      >Telefono</span
                    >
                  </div>
                </div>
          ...
          >
            <button
              ...
              [class]="
                canAccessLevel(2)
                  ? 'hover:bg-surface-hover/30 focus:bg-surface-hover/30'
                  : 'opacity-60'
              "
                ...
                @if (canAccessLevel(2)) {
                  <div class="mt-3 flex items-center gap-3">
                    <div class="flex items-center gap-1.5">
                      ...
                      <span
                        class="text-xs"
                        [class]="isDniVerified() ? 'text-success-600' : 'text-text-muted'"
                        >DNI</span
                      >
                    </div>
                    <div class="flex items-center gap-1.5">
                      ...
                      <span
                        class="text-xs"
                        [class]="isLicenseVerified() ? 'text-success-600' : 'text-text-muted'"
                        >Licencia</span
                      >
                    </div>
                  </div>
                ...
                <div class="px-5 sm:px-6 pb-6 pt-2 space-y-6 border-t border-border-subtle">
                  ...
                  <section>
                    <div class="flex items-center justify-between mb-4">
                      ...
                      @if (isDniVerified()) {
                        <span
                          class="px-3 py-1 rounded-full text-xs font-medium bg-success-100 text-success-700"
                        >
                          Verificado
                        </span>
                      }
        ...
        @if (progressPercentage() === 100) {
          <div
            class="mt-6 p-6 rounded-2xl bg-gradient-to-r from-success-50 to-success-100 border border-success-200 animate-fade-in-up"
          >
            <div class="flex items-start gap-4">
              <div
                class="flex-shrink-0 w-12 h-12 rounded-full bg-success-500 text-white flex items-center justify-center"
              >
              ...
              <div>
                ...
                <p class="mt-1 text-sm text-success-700">
                  Tu cuenta esta completamente verificada. Ahora puedes acceder a todas las
        ...
        <details class="mt-6 group">
          <summary
            class="p-4 rounded-2xl bg-surface-raised border border-border-subtle cursor-pointer list-none flex items-center justify-between hover:bg-surface-hover/50 transition-colors"
          >
            ...
            <svg
              class="w-5 h-5 text-text-muted transition-transform duration-300 group-open:rotate-180"
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
            >
          ...
          <div class="mt-3 p-5 rounded-2xl bg-surface-secondary/50 space-y-4">
            <div class="flex items-start gap-3">
              <div
                class="w-8 h-8 rounded-lg bg-info-100 flex items-center justify-center flex-shrink-0"
              >
                <svg
              ...
              <div>
                ...
                <p class="text-sm text-text-secondary">
                  Protegemos a todos los usuarios de la comunidad
                </p>
              </div>
            </div>
            <div class="flex items-start gap-3">
            ...
            <div class="flex items-start gap-3">
              ...
              <div>
                ...
                <p class="text-sm text-text-secondary">
                  Desbloquea la capacidad de rentar y publicar autos
                </p>
              </div>
            </div>
            <div class="flex items-start gap-3">
