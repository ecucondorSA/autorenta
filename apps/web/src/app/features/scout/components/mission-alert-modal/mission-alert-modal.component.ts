...
@Component({
  ...
  template: `
    <div class="h-full w-full bg-red-600 flex flex-col items-center justify-center p-6 text-white relative overflow-hidden">
      ...
      <div class="relative z-10 w-full max-w-md text-center space-y-8">
        ...
        <div class="relative mx-auto w-32 h-32 flex items-center justify-center">
          <div class="absolute inset-0 border-4 border-red-300 rounded-full animate-ping opacity-75"></div>
        ...
        <!-- Car Info Box -->
        <div class="bg-black/30 backdrop-blur-md rounded-2xl p-6 border border-red-400/50 shadow-2xl">
          ...
          <h2 class="text-2xl font-bold text-white">{{ mission.cars?.brand }} {{ mission.cars?.model }}</h2>
