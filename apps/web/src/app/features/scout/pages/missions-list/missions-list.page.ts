    ...
    <div class="min-h-screen bg-gray-50 pb-20">
      ...
      <div class="p-4">
        <div class="flex gap-2 overflow-x-auto no-scrollbar py-2">
          <span
            class="px-4 py-2 bg-indigo-100 text-indigo-700 rounded-full text-xs font-bold whitespace-nowrap"
            >Cerca de mí</span
          >
          <span
            class="px-4 py-2 bg-white text-gray-500 rounded-full text-xs font-medium whitespace-nowrap border"
            >Alta Prioridad</span
          >
          <span
            class="px-4 py-2 bg-white text-gray-500 rounded-full text-xs font-medium whitespace-nowrap border"
      ...
      <div class="px-4 space-y-4">
        @for (mission of scout.activeMissions(); track mission.id) {
          <div
            [routerLink]="['/scout/mission', mission.id]"
          ...
          >
            ...
            <div class="w-24 h-24 bg-gray-100 rounded-xl overflow-hidden flex-shrink-0">
              <img
                [src]="mission.cars?.photos?.[0] || 'assets/placeholders/car-placeholder.png'"
