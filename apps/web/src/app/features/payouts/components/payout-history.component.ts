      ...
      <div *ngIf="!loading() && payouts().length > 0" class="payouts-list">
        <div *ngFor="let payout of payouts()" class="payout-item">
          <div class="payout-icon" [ngClass]="'status-' + payout.status">
            ...
            <svg *ngIf="payout.status === 'pending' || payout.status === 'processing'" fill="currentColor" viewBox="0 0 20 20">
              <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm1-12a1 1 0 10-2 0v4a1 1 0 00.293.707l2.828 2.829a1 1 0 101.415-1.415L11 9.586V6z" clip-rule="evenodd" />
            </svg>
            <svg *ngIf="payout.status === 'failed' || payout.status === 'cancelled'" fill="currentColor" viewBox="0 0 20 20">
