...
@Component({
  ...
  template: `
    ...
    >
      <h3 class="text-lg font-semibold text-text-primary mb-4">Elegí tu método de pago</h3>
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        >
          <div class="flex flex-col items-center text-center space-y-3">
            <div class="w-12 h-12 bg-cta-default/20 rounded-full flex items-center justify-center">
              <svg
            ...
            <div>
              <p class="font-semibold text-text-primary">Pagar con tarjeta</p>
        ...
        >
          <div class="flex flex-col items-center text-center space-y-3">
            ...
            <div>
              ...
              <p class="text-xs text-text-secondary mt-1">Usa tu saldo AutoRenta • Sin tarjeta</p>
            </div>
          </div>
      ...
      <div class="mt-4 grid grid-cols-1 md:grid-cols-2 gap-3">
        <div class="p-3 bg-success-light/10 border border-success-light/40 rounded-lg">
          <div class="flex items-center gap-2">
            ...
            <span class="text-sm font-medium text-success-700">Pago seguro</span>
          </div>
        ...
        <div class="p-3 bg-cta-default/10 border border-cta-default/40 rounded-lg">
          <div class="flex items-center gap-2">
            <svg
            ...
            <span class="text-sm font-medium text-cta-default">Garantía incluida</span>
          </div>
