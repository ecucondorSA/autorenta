    ...
    <div
      ...
      <div class="overflow-x-auto">
        <table class="min-w-full divide-y divide-gray-200">
          ...
          <tbody
            class="bg-surface-raised divide-y divide-gray-200"
            >
            ...
            <tr>
              ...
              <td
                class="px-4 py-4 text-sm text-right font-medium text-text-primary"
                >
                {{
                formatUsd(
                paymentMode === 'card'
            ...
            <tr class="bg-surface-base">
              ...
              <td
                class="px-4 py-4 text-sm text-right font-semibold text-warning-700"
                >
      ...
      <div
        ...
        >
        <h4
          class="text-sm font-semibold text-cta-default mb-2 flex items-center gap-2"
          >
        ...
        <div class="text-xs text-cta-default space-y-2">
          @if (paymentMode === 'card') {
            <div
              class="bg-surface-raised/50 rounded p-3"
              >
          ...
          <div
            class="bg-success-light/10 border border-success-light/40 rounded p-3"
            >
            <p class="font-medium text-success-700 mb-1">
              ¿Qué está cubierto?
            </p>
