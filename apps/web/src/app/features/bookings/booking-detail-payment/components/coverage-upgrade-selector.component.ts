          ...
          <div class="flex-1">
            <div class="flex items-center justify-between">
              <span class="text-sm font-medium text-text-primary dark:text-text-primary"
                ...
                >
                <span class="text-sm font-semibold text-success-700 dark:text-success-strong"
                  >Incluido</span
                  >
                </div>
