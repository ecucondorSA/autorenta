...
@Component({
  ...
  template: `
    <div class="rounded-xl border border-pearl-gray/60 bg-white-pure shadow p-6 dark:border-neutral-800/70 dark:bg-anthracite transition-colors duration-300">
      <h3 class="text-lg font-semibold text-smoke-black dark:text-ivory-luminous mb-4">Términos y Consentimientos</h3>
      ...
      <div class="space-y-4">
        ...
        <label class="flex items-start space-x-3 cursor-pointer">
          ...
          <span class="text-sm text-gray-700 dark:text-pearl-light/80">
            Acepto los
            <a href="/terminos-y-condiciones" target="_blank" class="text-primary-600 hover:text-primary-700 dark:text-accent-petrol dark:hover:text-accent-petrol/80 underline">
              Términos y Condiciones
            </a>
            y la
            <a href="/politica-privacidad" target="_blank" class="text-primary-600 hover:text-primary-700 dark:text-accent-petrol dark:hover:text-accent-petrol/80 underline">
        ...
        >
          ...
          />
          <span class="text-sm text-gray-700 dark:text-pearl-light/80">
            Autorizo guardar mi tarjeta para cargos diferidos (multas, peajes, daños) según lo establecido en los Términos y Condiciones
            <span class="text-red-500">*</span>
          </span>
        </label>
      </div>
      ...
      <div class="mt-4 p-3 bg-gray-50 dark:bg-slate-deep/40 rounded-lg transition-colors duration-300">
        <p class="text-xs text-gray-600 dark:text-pearl-light/70">
          <strong>Importante:</strong> Al confirmar esta reserva, estás aceptando las condiciones de uso,
          franquicias y responsabilidades detalladas arriba. Los campos marcados con
          <span class="text-red-500">*</span> son obligatorios.
        </p>
      </div>

      <!-- Validation Errors -->
      <div *ngIf="!consents.termsAccepted || (paymentMode === 'card' && !consents.cardOnFileAccepted)"
