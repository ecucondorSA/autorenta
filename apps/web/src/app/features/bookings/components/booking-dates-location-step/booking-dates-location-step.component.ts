        ...
        <div class="form-section">
          ...
          <div class="form-grid">
            ...
            <div class="form-field">
              ...
              <select id="endTime" class="field-input" [(ngModel)]="localData.dropoffTime" required>
                @for (time of availableTimes; track time) {
                  <option [value]="time">{{ time }}</option>
                }
              </select>
          ...
          @if (durationDays() > 0) {
            <div class="duration-info">
              ...
              <span
                >Duración total: {{ durationDays() }} día{{ durationDays() > 1 ? 's' : '' }}</span
              >
            </div>
          }
        </div>
            ...
            <div class="location-warning">
              ...
              <div>
                ...
                <p class="warning-text">
                  Ten en cuenta que podrían aplicarse cargos adicionales por devolución en ubicación
                  diferente.
                </p>
              </div>
            </div>
