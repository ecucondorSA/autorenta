...
@Component({
  ...
  `,
  styles: [`
    .extras-step-container { max-width: 800px; margin: 0 auto; }
    ...
    .extra-card { margin-bottom: 1rem; transition: all 0.2s; }
    .extra-card.selected { border: 2px solid var(--ion-color-primary); }
    .extra-header { display: flex; justify-content: space-between; align-items: center; margin-bottom: 1rem; }
    .extra-info { display: flex; gap: 1rem; align-items: center; flex: 1; }
    .extra-icon { font-size: 2rem; color: var(--ion-color-primary); }
    .extra-info h3 { font-size: 1.1rem; font-weight: 600; margin: 0; }
    .extra-info p { font-size: 0.85rem; color: var(--ion-color-medium); margin: 0.25rem 0 0; }
    .extra-price { font-size: 1.1rem; font-weight: 700; color: var(--ion-color-primary); }
    .quantity-selector { display: flex; align-items: center; gap: 1rem; justify-content: center; }
    .quantity { font-size: 1.2rem; font-weight: 600; min-width: 30px; text-align: center; }
    .summary-item { display: flex; justify-content: space-between; padding: 0.5rem 0; border-bottom: 1px solid var(--ion-color-light); }
  `]
})
export class BookingExtrasStepComponent implements OnInit {
  ...
  availableExtras = signal<Extra[]>([
    { id: '1', type: 'gps', name: 'GPS', description: 'Navegador GPS portátil', icon: 'navigate-outline', dailyRate: 5, quantity: 0, maxQuantity: 2 },
    { id: '2', type: 'child_seat', name: 'Silla para niños', description: 'Asiento de seguridad certificado', icon: 'person-outline', dailyRate: 3, quantity: 0, maxQuantity: 3 },
    { id: '3', type: 'additional_driver', name: 'Conductor adicional', description: 'Agregar otro conductor autorizado', icon: 'people-outline', dailyRate: 10, quantity: 0, maxQuantity: 2 },
    { id: '4', type: 'toll_pass', name: 'Pase de peajes', description: 'Pago automático de peajes', icon: 'card-outline', dailyRate: 8, quantity: 0, maxQuantity: 1 },
    { id: '5', type: 'delivery', name: 'Entrega a domicilio', description: 'Llevamos el auto a tu ubicación', icon: 'car-outline', dailyRate: 20, quantity: 0, maxQuantity: 1 },
  ]);
