...
@Component({
  ...
  styles: [`
    ...
    .nav-item.dashboard-btn {
      background: linear-gradient(135deg, rgba(248, 244, 236, 0.6) 0%, rgba(223, 210, 191, 0.4) 100%);
      border-radius: 12px;
      margin: 4px;
    }

    .nav-item.dashboard-btn:hover {
      background: linear-gradient(135deg, rgba(248, 244, 236, 0.8) 0%, rgba(223, 210, 191, 0.6) 100%);
    }
    ...
    .dashboard-item {
      ...
      gap: 8px;
      padding: 20px 12px;
      background: linear-gradient(135deg, rgba(255, 255, 255, 0.9) 0%, rgba(248, 244, 236, 0.8) 100%);
    ...
    .dashboard-item:active {
      ...
      background: linear-gradient(135deg, rgba(223, 210, 191, 0.9) 0%, rgba(223, 210, 191, 0.7) 100%);
      border-color: #A7D8F4;
    }
