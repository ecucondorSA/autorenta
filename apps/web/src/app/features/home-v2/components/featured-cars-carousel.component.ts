        ...
        <div class="carousel-track">
          @if (isLoading()) {
            ...
            @for (car of cars(); track car.id) {
              <div class="car-card" (click)="carClick.emit(car)">
                <!-- Image -->
                <div class="car-image-wrapper">
                  ...
                  >
                    <svg
                      ...
                      height="20"
                      viewBox="0 0 20 20"
                      [attr.fill]="isFavorite(car.id) ? 'currentColor' : 'none'"
                    >
                      <path
                        d="M10 17L3.5 11C1.5 9 1.5 6 3.5 4C5.5 2 8 2 10 4C12 2 14.5 2 16.5 4C18.5 6 18.5 9 16.5 11L10 17Z"
                        stroke="currentColor"
                        stroke-width="1.5"
                        stroke-linejoin="round"
                      />
                ...
                <div class="car-content">
                  ...
                  <div class="car-meta">
                    <div class="rating">
                      <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
                        <path
                          d="M8 1L10 5.5H14.5L11 8.5L12.5 13L8 10L3.5 13L5 8.5L1.5 5.5H6L8 1Z"
                          fill="#FBBF24"
                        />
                      </svg>
                  ...
                  <div class="car-location">
                    <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
                      ...
                      />
                      <path
                        d="M8 14C8 14 12 10 12 6.5C12 3.73858 10.2091 1.5 8 1.5C5.79086 1.5 4 3.73858 4 6.5C4 10 8 14 8 14Z"
                        stroke="currentColor"
                        stroke-width="1.5"
                      />
                    </svg>
...
export class FeaturedCarsCarouselComponent implements AfterViewInit, OnDestroy {
  ...
  ngAfterViewInit(): void {
    ...
    // Setup swipe gesture
    this.cleanupGesture = this.gestureService.onSwipe(container, (event: SwipeEvent) => {
