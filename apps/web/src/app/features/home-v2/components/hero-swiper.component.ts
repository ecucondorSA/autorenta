import { Component, OnInit, OnDestroy, signal, inject, PLATFORM_ID, AfterViewInit, ViewChild, ElementRef } from '@angular/core';
          ...
          >
            ...
            <div class="slide-content">
              <div class="content-wrapper">
                ...
                <button 
                  (click)="slide.ctaAction()"
                  class="cta-button animate-in delay-200"
                >
                  {{ slide.cta }}
      ...
      @if (showSwipeHint()) {
        <div class="swipe-hint">
          <svg width="40" height="40" viewBox="0 0 40 40">
            <path d="M15 20L25 20M25 20L20 15M25 20L20 25" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
          </svg>
