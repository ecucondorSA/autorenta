    ...
    <div class="v2-preview">
      ...
      <div class="hero">
        <div class="container">
          ...
          <p class="subtitle">
            Una nueva experiencia móvil-first. PWA completa con offline-mode, animaciones fluidas y
            una UX innovadora.
          </p>
          ...
          <div class="cta-buttons">
            ...
            <a
              href="https://github.com/ecucondorSA/autorenta/tree/v2"
              target="_blank"
      ...
      <div class="footer-cta">
        <div class="container">
          ...
          <a routerLink="/referrals" class="btn btn-primary btn-lg"> Unirme al programa beta </a>
        </div>
      </div>
    </div>
  `,
