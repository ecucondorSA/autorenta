        ...
        <div class="eligibility-card">
          <div class="eligibility-header">
            ...
            <span
              ...
              [class.eligible]="eligibility()!.eligible"
              [class.not-eligible]="!eligibility()!.eligible"
              >
          ...
          <div class="waterfall-steps">
            ...
            @if (breakdown()!.holdCaptured > 0) {
              <div class="waterfall-step">
                ...
                <div class="step-bar">
                  <div
                    class="step-fill hold"
                    [style.width.%]="calculatePercentage(breakdown()!.holdCaptured)"
                  ></div>
                </div>
              </div>
            }
            ...
            @if (breakdown()!.walletDebited > 0) {
              <div class="waterfall-step">
                ...
                <div class="step-bar">
                  <div
                    class="step-fill wallet"
                    [style.width.%]="calculatePercentage(breakdown()!.walletDebited)"
                  ></div>
                </div>
              </div>
            }
            ...
            @if (breakdown()!.extraCharged > 0) {
              <div class="waterfall-step">
                ...
                <div class="step-bar">
                  <div
                    class="step-fill extra"
                    [style.width.%]="calculatePercentage(breakdown()!.extraCharged)"
                  ></div>
                </div>
              </div>
            }
            ...
            @if (breakdown()!.fgoPaid > 0) {
              <div class="waterfall-step">
                ...
                <div class="step-bar">
                  <div
                    class="step-fill fgo"
                    [style.width.%]="calculatePercentage(breakdown()!.fgoPaid)"
                  ></div>
                </div>
              </div>
            }
            ...
            @if (breakdown()!.remainingUncovered > 0) {
              <div class="waterfall-step warning">
                <div class="step-header">
                ...
                <div class="step-amount warning">
                  \${{ formatAmount(breakdown()!.remainingUncovered) }}
                </div>
                <div class="step-bar">
                  <div
                    class="step-fill uncovered"
                    [style.width.%]="calculatePercentage(breakdown()!.remainingUncovered)"
                  ></div>
                </div>
              </div>
            }
            ...
            @if (breakdown()!.remainingUncovered > 0) {
              <div class="summary-row">
                ...
                <span class="summary-value warning"
                  >\${{ formatAmount(breakdown()!.remainingUncovered) }}</span
                  >
                </div>
              }
  ...
  async simulate(): Promise<void> {
    ...
    try {
      ...
      if (result.eligibility && result.estimatedBreakdown) {
        ...
        this.error.set(
          'No se pudo simular el waterfall. Verifica que el booking tenga un snapshot de riesgo.',
        );
      }
    } catch (err) {
