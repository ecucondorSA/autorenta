...
import { DisputesService, Dispute, DisputeStatus } from '../../../../core/services/disputes.service';
...
@Component({
  ...
  template: `
    <div class="container mx-auto p-6">
      ...
      <div *ngIf="loading()" class="loading loading-spinner loading-lg"></div>
            ...
            <div class="card bg-base-100 shadow-xl">
              <div class="card-body">
                <h2 class="card-title flex justify-between">
                  ...
                  <span class="text-sm font-normal text-gray-500">{{ dispute()?.created_at | date:'medium' }}</span>
                </h2>
                ...
                <div class="flex flex-wrap gap-2 text-sm">
                  <span class="badge badge-ghost">Abierta por: {{ dispute()?.opened_by | slice:0:8 }}...</span>
                  <span class="badge badge-ghost">Reserva ID: {{ dispute()?.booking_id | slice:0:8 }}...</span>
                </div>
              </div>
            </div>
      ...
      <div *ngIf="!loading() && !dispute()" class="alert alert-warning">
