  ...
  template: `
    <div class="static-page">
      ...
      <div class="static-content">
        ...
        <p>
          La comunidad Autorentar es un espacio donde arrendatarios y propietarios pueden
          conectarse, compartir consejos y aprender unos de otros.
        </p>
        ...
        <div class="card-grid">
          <div class="info-card">
            ...
            <p>
              Participa en conversaciones sobre alquileres, consejos de viaje y más. (Próximamente)
            </p>
          </div>
          <div class="info-card">
        ...
        <p>
          Organizamos eventos periódicos donde la comunidad puede reunirse, conocerse y disfrutar de
          experiencias automotrices únicas.
        </p>
