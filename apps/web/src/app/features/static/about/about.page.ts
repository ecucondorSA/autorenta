  ...
  template: `
    ...
    <header class="relative min-h-[80vh] flex items-center justify-center overflow-hidden">
      ...
      <div class="relative z-10 container mx-auto px-4 text-center text-white">
        <div class="inline-flex items-center gap-2 px-4 py-2 bg-white/10 backdrop-blur-md rounded-full text-sm mb-6 border border-white/20">
        ...
        <h1 class="text-5xl md:text-7xl font-black mb-6 tracking-tight leading-tight">
          Democratizamos<br/>
          <span class="text-[#00d95f]">
            la movilidad
          </span>
        </h1>

        <p class="text-xl md:text-2xl text-gray-300 max-w-3xl mx-auto mb-10 leading-relaxed">
          Conectamos a personas que necesitan un auto con propietarios que quieren
          generar ingresos. Sin intermediarios, sin burocracia.
        </p>
        ...
        @if (stats$ | async; as stats) {
          <div class="flex flex-wrap justify-center gap-8 md:gap-16">
            ...
            <div class="text-center">
              <div class="text-4xl md:text-5xl font-black text-white">{{ stats.completed_trips }}+</div>
    ...
    <section class="py-20 bg-white">
      <div class="container mx-auto px-4">
        <div class="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
          <!-- Misión -->
          <div class="p-8 bg-gradient-to-br from-gray-50 to-white rounded-2xl border border-gray-100 shadow-sm">
            <div class="w-12 h-12 bg-[#00d95f] rounded-xl flex items-center justify-center text-2xl mb-6">
              🎯
            </div>
            <h2 class="text-2xl font-bold text-gray-900 mb-4">Nuestra Misión</h2>
            <p class="text-gray-600 leading-relaxed">
              Hacer que la movilidad sea accesible para todos. Creemos que el acceso
              a un vehículo no debería requerir trámites interminables ni tarjetas
              de crédito internacionales. Simplificamos el proceso para que cualquiera
              pueda alquilar un auto en minutos.
            </p>
          </div>
          ...
          <div class="p-8 bg-gradient-to-br from-gray-900 to-gray-800 rounded-2xl text-white">
            ...
            <p class="text-gray-300 leading-relaxed">
              Ser la plataforma líder de car-sharing P2P en Latinoamérica. Un futuro
              donde compartir un auto sea tan natural como compartir un departamento,
              reduciendo la cantidad de vehículos estacionados y el impacto ambiental.
            </p>
          </div>
        </div>
      </div>
        ...
        <div class="max-w-4xl mx-auto">
          @for (milestone of milestones; track milestone.date; let i = $index) {
            <div class="relative flex gap-6 pb-12 last:pb-0">
              ...
              <!-- Icon -->
              <div class="w-12 h-12 bg-white rounded-full border-4 border-[#00d95f] flex items-center justify-center text-xl shrink-0 z-10 shadow-lg">
                {{ milestone.icon }}
              </div>
        ...
        <div class="max-w-5xl mx-auto">
          <div class="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div class="relative">
              ...
              <!-- Floating card -->
              <div class="absolute -bottom-6 -right-6 bg-white rounded-xl shadow-xl p-4 border border-gray-100">
            ...
            <!-- Content -->
            <div>
              <div class="inline-flex items-center gap-2 px-3 py-1 bg-green-100 rounded-full text-green-800 text-sm font-medium mb-6">
                👋 Conocé al fundador
              </div>
              ...
              <p class="text-lg text-gray-500 mb-4">
                ...
                <a href="https://autamedica.com" target="_blank" rel="noopener" class="text-blue-600 hover:underline">AutaMedica</a> &
                <a href="https://ecucondor.com" target="_blank" rel="noopener" class="text-blue-600 hover:underline">EcuCóndor</a>
              </p>

              <div class="space-y-4 text-gray-600 leading-relaxed">
                <p>
                  "Soy brasileño viviendo en Argentina. Mi formación en medicina en la UBA
                  me enseñó a identificar problemas y buscar soluciones. Fundé
                  <strong>AutaMedica</strong> para eliminar la fricción en las consultas
                  médicas usando tecnología e IA."
                </p>
                <p>
                  "Con mi novia ecuatoriana, creamos <strong>EcuCóndor</strong> para resolver
                  el problema del cambio de divisas para migrantes latinos. Hoy operamos
                  en Ecuador, Argentina y Brasil con miles de usuarios."
                </p>
                <p>
                  "Cuando quise alquilar un auto en Argentina, descubrí que sin tarjeta
                  de crédito internacional era imposible. Ese dolor personal se convirtió
                  en <strong>AutoRenta</strong>: alquiler P2P sin barreras."
                </p>
                <p class="font-semibold text-gray-900">
                  "Transformo sectores complejos mediante tecnología. Salud, finanzas,
                  movilidad - el patrón es el mismo: eliminar fricciones."
                </p>
              </div>
      ...
      <div class="container mx-auto px-4">
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto">
          @for (value of values; track value.title) {
            <div class="group p-6 bg-gradient-to-br from-gray-50 to-white rounded-2xl border border-gray-100 hover:border-[#00d95f] hover:shadow-lg transition-all">
      ...
      <div class="container mx-auto px-4">
        ...
        <div class="max-w-5xl mx-auto">
          <div class="grid md:grid-cols-2 gap-8">
            <!-- AutoRenta -->
            <div class="bg-gradient-to-br from-[#00d95f] to-[#00bf54] rounded-2xl p-8 text-gray-900">
              <div class="flex items-center gap-3 mb-6">
                <div class="w-12 h-12 bg-white rounded-xl flex items-center justify-center">
                  <img src="/assets/images/logo-autorentar-v5.png" alt="AutoRenta" class="w-8 h-8 object-contain" />
                </div>
                <span class="text-2xl font-black">AutoRenta</span>
              </div>
              <ul class="space-y-4">
                <li class="flex items-start gap-3">
                  <svg class="w-6 h-6 text-green-700 shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                    <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"/>
                  </svg>
                  <span><strong>Sin tarjeta internacional</strong> - Aceptamos PIX, MercadoPago, efectivo</span>
                </li>
                <li class="flex items-start gap-3">
                  <svg class="w-6 h-6 text-green-700 shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                    <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"/>
    ...
    <section class="py-20 bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 text-white">
      <div class="container mx-auto px-4 text-center">
        ...
        <p class="text-xl text-gray-400 max-w-2xl mx-auto mb-10">
          Unite a miles de personas que ya disfrutan de la libertad de alquilar
          sin complicaciones.
        </p>
...
export class AboutPage {
  ...
  stats$ = this.http.get<PlatformStats>(`${environment.supabaseUrl}/functions/v1/public-investor-stats`).pipe(
    map(data => ({
  ...
  milestones: Milestone[] = [
    {
      ...
      description: 'Desde la UBA, Eduardo funda AutaMedica: plataforma de telemedicina con IA para eliminar la fricción en consultas médicas.',
      icon: '🏥'
    },
    {
      date: '2022',
      title: 'EcuCóndor - FinTech',
      description: 'Junto a su novia ecuatoriana, crea la plataforma de cambio de divisas para migrantes latinos. +USD 200K transaccionados entre 2024-2025.',
      icon: '💱'
    },
    {
      date: '2026',
      title: 'AutoRenta lanza',
      description: 'La experiencia personal de no poder alquilar autos sin tarjeta internacional se convierte en solución: alquiler P2P sin barreras.',
      icon: '🚗'
    },
    {
      date: 'Hoy',
      title: 'Ecosistema completo',
      description: 'Tres empresas, un mismo ADN: eliminar fricciones con tecnología. Salud, finanzas y movilidad conectados.',
      icon: '🔗'
    }
  ];
  ...
  values = [
    {
      icon: '🤝',
      title: 'Confianza',
      description: 'Verificamos cada usuario, cada vehículo, cada transacción. Tu seguridad es nuestra prioridad.'
    },
    {
      icon: '🌱',
      title: 'Sustentabilidad',
      description: 'Cada auto compartido es un auto menos estacionado. Optimizamos recursos existentes.'
    },
    {
      icon: '💡',
      title: 'Innovación',
      description: 'Usamos IA para inspecciones, pagos instantáneos y la mejor experiencia de usuario.'
    },
    {
      icon: '❤️',
      title: 'Comunidad',
