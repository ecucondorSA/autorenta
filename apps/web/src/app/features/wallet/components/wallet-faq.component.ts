...
@Component({
  ...
  template: `
    <div
      class="bg-surface-raised dark:bg-surface-raised rounded-xl shadow-sm border border-border-default dark:border-gray-700 p-6"
    >
      <!-- Header -->
      <div class="mb-6">
      ...
      <div class="space-y-3">
        <div
          *ngFor="let item of faqItems(); let i = index"
          class="border border-border-default dark:border-gray-700 rounded-lg overflow-hidden transition-all duration-200"
        ...
        >
          ...
          <button
            type="button"
            (click)="toggleItem(i)"
            class="w-full px-4 py-3 flex items-center justify-between text-left hover:bg-border-default/20 dark:hover:bg-gray-800 transition-colors duration-200"
          >
          ...
          <div
            *ngIf="item.expanded"
            class="px-4 pb-4 pt-2 bg-border-default/10 dark:bg-gray-800/50 border-t border-border-default dark:border-gray-700"
          >
            <p
  ...
  readonly faqItems = signal<FaqItem[]>([
    ...
    },
    {
      ...
      answer: `Podés cargar saldo de <strong>3 formas</strong>:
        ...
        <p class="mt-2 text-xs text-amber-700 dark:text-amber-500">⚠️ Los fondos cargados en efectivo <strong>no son retirables</strong>, pero sí reutilizables para reservas.</p>`,
      expanded: false,
    },
    {
    ...
    },
    {
      ...
      answer: `El <strong>Crédito de Seguridad</strong> es una garantía de <strong>US$ 600</strong> que se bloquea al hacer una reserva sin tarjeta:
        ...
        <p class="mt-2 text-xs text-success-light dark:text-success-light">💡 <strong>Ventaja:</strong> Con US$ 600 en tu wallet, podés hacer reservas ilimitadas sin volver a cargar.</p>`,
      expanded: false,
    },
    {
    ...
    },
    {
      ...
      answer: `
        <table class="w-full text-xs mt-2 border-collapse">
          <thead>
            <tr class="bg-border-default/30 dark:bg-gray-800">
              <th class="border border-border-default dark:border-gray-700 px-2 py-1 text-left">Característica</th>
              <th class="border border-border-default dark:border-gray-700 px-2 py-1">Wallet</th>
              <th class="border border-border-default dark:border-gray-700 px-2 py-1">Tarjeta</th>
            </tr>
          </thead>
          <tbody>
            <tr>
              <td class="border border-border-default dark:border-gray-700 px-2 py-1"><strong>Confirmación</strong></td>
              <td class="border border-border-default dark:border-gray-700 px-2 py-1 text-center">⚡ Instantánea</td>
              <td class="border border-border-default dark:border-gray-700 px-2 py-1 text-center">⏱️ 1-2 min</td>
            </tr>
            <tr class="bg-border-default/10 dark:bg-gray-800/30">
              <td class="border border-border-default dark:border-gray-700 px-2 py-1"><strong>Comisiones</strong></td>
              <td class="border border-border-default dark:border-gray-700 px-2 py-1 text-center">✅ Sin comisiones</td>
              <td class="border border-border-default dark:border-gray-700 px-2 py-1 text-center">➖ Según tu banco</td>
            </tr>
            <tr>
              <td class="border border-border-default dark:border-gray-700 px-2 py-1"><strong>Garantía</strong></td>
              <td class="border border-border-default dark:border-gray-700 px-2 py-1 text-center">♻️ Reutilizable</td>
              <td class="border border-border-default dark:border-gray-700 px-2 py-1 text-center">🔒 Se libera post-alquiler</td>
            </tr>
            <tr class="bg-border-default/10 dark:bg-gray-800/30">
              <td class="border border-border-default dark:border-gray-700 px-2 py-1"><strong>Requisito</strong></td>
              <td class="border border-border-default dark:border-gray-700 px-2 py-1 text-center">💰 Saldo previo</td>
              <td class="border border-border-default dark:border-gray-700 px-2 py-1 text-center">💳 Tarjeta válida</td>
            </tr>
          </tbody>
        </table>
    ...
    },
    {
      ...
      answer: `Depende de la <strong>severidad</strong> y <strong>culpabilidad</strong> del siniestro:
        ...
        <p class="mt-2 text-xs text-success-light dark:text-success-light">🛡️ <strong>Protector de Bonus:</strong> Podés comprar un "Protector" ($15-$45) que previene el aumento de clase en 1-3 siniestros.</p>`,
      expanded: false,
    },
    {
      ...
      answer: `AutoRenta usa <strong>3 sistemas independientes</strong> para evaluar conductores de forma objetiva:
        ...
        <p class="mt-2 text-xs text-success-light dark:text-success-light">✅ <strong>Transparencia total:</strong> Podés ver tu historial completo, badges de desempeño y progreso hacia mejor clase.</p>`,
      expanded: false,
    },
    {
      ...
      answer: `<strong>¡SÍ!</strong> AutoRenta premia a los buenos conductores con un sistema de bonus robusto:
        ...
        <p class="mt-2 text-xs text-success-light dark:text-success-light">🏆 <strong>Gamificación:</strong> Badges visuales, mensajes motivacionales, y progreso visible hacia tu próxima mejora de clase.</p>`,
      expanded: false,
    },
    {
      ...
      answer: `El Crédito de Protección <strong>NO se pierde todo</strong> - solo se consume <strong>lo que cuesta el daño</strong>:
        ...
        <table class="w-full text-xs mt-2 border-collapse">
          <thead>
            <tr class="bg-border-default/30 dark:bg-gray-800">
              <th class="border border-border-default dark:border-gray-700 px-2 py-1">Daño</th>
              <th class="border border-border-default dark:border-gray-700 px-2 py-1">CP Usado</th>
              <th class="border border-border-default dark:border-gray-700 px-2 py-1">CP Restante</th>
              <th class="border border-border-default dark:border-gray-700 px-2 py-1">Pagás de tu bolsillo</th>
            </tr>
          </thead>
          <tbody>
            <tr>
              <td class="border border-border-default dark:border-gray-700 px-2 py-1 text-center">$100</td>
              <td class="border border-border-default dark:border-gray-700 px-2 py-1 text-center">$100</td>
              <td class="border border-border-default dark:border-gray-700 px-2 py-1 text-center text-success-light">✅ $200</td>
              <td class="border border-border-default dark:border-gray-700 px-2 py-1 text-center text-success-light">$0</td>
            </tr>
            <tr class="bg-border-default/10 dark:bg-gray-800/30">
              <td class="border border-border-default dark:border-gray-700 px-2 py-1 text-center">$250</td>
              <td class="border border-border-default dark:border-gray-700 px-2 py-1 text-center">$250</td>
              <td class="border border-border-default dark:border-gray-700 px-2 py-1 text-center text-amber-700">⚠️ $50</td>
              <td class="border border-border-default dark:border-gray-700 px-2 py-1 text-center text-success-light">$0</td>
            </tr>
            <tr>
              <td class="border border-border-default dark:border-gray-700 px-2 py-1 text-center">$400</td>
              <td class="border border-border-default dark:border-gray-700 px-2 py-1 text-center">$300</td>
              <td class="border border-border-default dark:border-gray-700 px-2 py-1 text-center text-red-700">❌ $0</td>
              <td class="border border-border-default dark:border-gray-700 px-2 py-1 text-center text-red-700">$100</td>
            </tr>
          </tbody>
        </table>
        ...
        <p class="mt-2 text-xs text-success-light dark:text-success-light">🛡️ <strong>Protector de Bonus:</strong> Compralo antes ($15-$45) para que tu clase NO aumente aunque tengas siniestro.</p>`,
      expanded: false,
    },
    {
