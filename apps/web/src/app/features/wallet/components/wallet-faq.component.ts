  ...
  readonly faqItems = signal<FaqItem[]>([
    ...
    },
    {
      ...
      answer: `El <strong>Crédito de Seguridad</strong> es una garantía de <strong>US$ 600</strong> que se bloquea al hacer una reserva sin tarjeta:
        ...
        <p class="mt-2 text-xs text-green-700 dark:text-green-500">💡 <strong>Ventaja:</strong> Con US$ 600 en tu wallet, podés hacer reservas ilimitadas sin volver a cargar.</p>`,
      expanded: false,
    },
    {
    ...
    },
    {
      ...
      answer: `AutoRenta usa <strong>3 sistemas independientes</strong> para evaluar conductores de forma objetiva:
        ...
        <p class="mt-2 text-xs text-green-700 dark:text-green-500">✅ <strong>Transparencia total:</strong> Podés ver tu historial completo, badges de desempeño y progreso hacia mejor clase.</p>`,
      expanded: false,
    },
    {
