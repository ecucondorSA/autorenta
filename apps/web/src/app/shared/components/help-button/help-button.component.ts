  ...
  template: `
    <div class="relative">
      ...
      @if (showMenu()) {
        ...
        >
          <h3 class="text-sm font-semibold mb-3 text-gray-900 dark:text-ivory-50">
            ¿Necesitás ayuda?
          </h3>

          <button
            (click)="showTour('welcome')"
            class="w-full text-left px-3 py-2 rounded-lg hover:bg-beige-100 dark:hover:bg-gray-700 text-sm mb-2 transition-base text-gray-600 dark:text-beige-200"
            role="menuitem"
          >
          ...
          <hr class="my-2 border-gray-200/40 dark:border-white/10" />

          <a
            href="mailto:soporte@autorentar.com"
            class="w-full text-left px-3 py-2 rounded-lg hover:bg-beige-100 dark:hover:bg-gray-700 text-sm flex items-center gap-2 transition-base text-gray-600 dark:text-beige-200"
            role="menuitem"
          >
            <svg
              class="w-4 h-4"
