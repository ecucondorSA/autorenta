...
@Component({
  ...
  template: `
    @if (profile(); as p) {
      <div class="renter-badge" [class]="'badge-' + p.badge_level">
        ...
        <div class="badge-details">
          ...
          <div class="badge-stats">
            @if (p.total_rentals > 0) {
              <span class="stat" title="Alquileres completados"> 🚗 {{ p.total_rentals }} </span>
            }
        ...
        @if (p.has_protection) {
          <div class="protection-badge" title="Tiene Protector de Bonus activo">🛡️</div>
        }
      </div>
    }
  ...
  styles: [
    `
      ...
      .badge-excelente .badge-label {
        color: #047857;
      }
      .badge-bueno .badge-label {
        color: #1d4ed8;
      }
      .badge-regular .badge-label {
        color: #b45309;
      }
      .badge-atencion .badge-label {
        color: #dc2626;
      }
