 ...
 * Controlled via SplashScreenService (injected globally).
 *
 * Note: The service uses direct DOM manipulation as a fallback
 * to ensure the splash hides reliably with OnPush change detection.
 */
@Component({
      ...
      >
        ...
        >
          <defs>
            ...
            <style>
              @keyframes splash-wheelSpin { from { transform: rotate(0deg); } to { transform: rotate(360deg); } }
              @keyframes splash-carMove { 0%, 100% { transform: translateX(0); } 50% { transform: translateX(15px); } }
              @keyframes splash-pulse { 0%, 100% { opacity: 1; } 50% { opacity: 0.7; } }
          ...
          <g class="splash-car" filter="url(#splash-shadow)" transform="translate(100, 60)">
            ...
            <path fill="url(#splash-carGradient)" d="M 20,95 C 20,85 25,70 40,60 L 60,50 C 75,42 90,30 110,20 C 120,14 135,10 160,10 L 220,12 C 250,12 270,20 285,40 L 300,60 C 315,65 325,80 325,95 L 325,105 C 325,110 322,112 318,112 L 290,112 C 285,95 265,88 245,88 C 220,88 205,105 200,112 L 100,112 C 95,105 80,88 55,88 C 35,88 20,105 15,112 L 10,112 C 5,112 2,110 2,105 L 2,95 Z" />
            <path fill="#111827" d="M 110,20 C 120,14 135,10 160,10 L 220,12 C 235,12 250,15 265,25 L 220,14 L 160,12 C 145,12 125,16 110,20 Z" />
            <path fill="#fff" opacity="0.2" d="M 115,22 C 130,15 155,12 180,14 L 210,16 L 250,30 L 280,55 L 80,55 C 95,35 105,25 115,22 Z" />
            ...
            <g transform="translate(55, 112)">
              <circle r="22" fill="#0f172a" /><circle r="18" fill="#374151" /><circle r="14" fill="url(#splash-rimGradient)" />
              ...
              <circle r="5" fill="#475569" /><circle r="3" fill="#94a3b8" />
            </g>
            <!-- Rueda delantera -->
          ...
          <!-- Texto -->
          <text x="250" y="215" text-anchor="middle" class="splash-text" font-family="system-ui, -apple-system, sans-serif" font-size="42" font-weight="800" fill="#1e293b">
            AUTO<tspan fill="#d4f542">RENTAR</tspan>
          </text>
          <text x="250" y="245" text-anchor="middle" class="splash-subtitle" font-family="system-ui, -apple-system, sans-serif" font-size="12" font-weight="500" fill="#64748b" letter-spacing="3">
...
export class SplashScreenComponent {
  protected readonly splashService = inject(SplashScreenService);
}
