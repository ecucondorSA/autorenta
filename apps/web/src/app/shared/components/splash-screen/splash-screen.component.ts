        ...
        >
          <defs>
            ...
            <style>
              ...
              .splash-car {
                animation: splash-carMove 2s ease-in-out infinite;
              }
              .splash-wheel {
                animation: splash-wheelSpin 1s linear infinite;
              }
              .splash-text {
                animation: splash-fadeInUp 0.8s ease-out forwards;
              }
              .splash-subtitle {
                animation: splash-fadeInUp 0.8s ease-out 0.3s forwards;
                opacity: 0;
              }
              .splash-loader {
          ...
          <g class="splash-car" filter="url(#splash-shadow)" transform="translate(100, 60)">
            ...
            <path
              fill="url(#splash-carGradient)"
              d="M 20,95 C 20,85 25,70 40,60 L 60,50 C 75,42 90,30 110,20 C 120,14 135,10 160,10 L 220,12 C 250,12 270,20 285,40 L 300,60 C 315,65 325,80 325,95 L 325,105 C 325,110 322,112 318,112 L 290,112 C 285,95 265,88 245,88 C 220,88 205,105 200,112 L 100,112 C 95,105 80,88 55,88 C 35,88 20,105 15,112 L 10,112 C 5,112 2,110 2,105 L 2,95 Z"
            />
            <path
              fill="#111827"
              d="M 110,20 C 120,14 135,10 160,10 L 220,12 C 235,12 250,15 265,25 L 220,14 L 160,12 C 145,12 125,16 110,20 Z"
            />
            <path
              fill="#fff"
              opacity="0.2"
              d="M 115,22 C 130,15 155,12 180,14 L 210,16 L 250,30 L 280,55 L 80,55 C 95,35 105,25 115,22 Z"
            />
            <path
              fill="url(#splash-windowGrad)"
              d="M 95,28 C 90,38 85,48 82,58 L 115,58 L 115,28 C 108,27 100,27 95,28 Z"
            />
            <path
              fill="url(#splash-windowGrad)"
              d="M 122,26 L 190,28 C 210,30 230,42 248,58 L 122,58 Z"
            />
            ...
            <path
              ...
              stroke-width="1.5"
              opacity="0.6"
              d="M 25,90 C 100,88 200,88 315,100"
            />
            <!-- Rueda trasera -->
          ...
          >
            AUTO
            <tspan fill="#d4f542">RENTAR</tspan>
          </text>
          <text
            x="250"
            y="245"
