...
@Component({
  ...
  template: `
    <div
      class="flex flex-col h-[500px] bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-100"
    >
      <!-- Header -->
      <div class="bg-gray-50 p-4 border-b border-gray-100 flex justify-between items-center">
        ...
        <div
          class="flex items-center gap-2 text-xs bg-green-100 text-green-700 px-2 py-1 rounded-full"
        >
      ...
      <div class="flex-1 overflow-y-auto p-4 space-y-4 bg-gray-50/50" #scrollContainer>
        @for (msg of messages(); track msg.id) {
          ...
          @if (msg.is_system_message) {
            ...
            <div
              class="flex"
              [ngClass]="{ 'justify-end': msg.is_mine, 'justify-start': !msg.is_mine }"
            >
              <div
                class="max-w-[80%] rounded-2xl px-4 py-2 shadow-sm relative group"
                [ngClass]="{
              ...
              >
                ...
                @if (msg.is_flagged) {
                  <div
                    class="absolute -bottom-5 right-0 text-[10px] text-orange-500 flex items-center gap-1"
                  >
