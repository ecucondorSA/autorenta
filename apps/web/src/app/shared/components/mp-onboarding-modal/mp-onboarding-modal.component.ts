    ...
    <ion-content class="ion-padding">
      ...
      <div *ngIf="!loading()" class="onboarding-content">
        ...
        <ion-card class="warning-box" color="warning">
          <ion-card-content>
            ...
            <div class="warning-text">
              ...
              <p>Si no tenés, podés crearla gratis en <a href="https://www.mercadopago.com.ar" target="_blank">mercadopago.com.ar</a></p>
            </div>
          </ion-card-content>
        </ion-card>
        ...
        <ion-note color="medium" class="terms">
          Al vincular tu cuenta, autorizás a Autorentar a procesar pagos en tu nombre.
          Podés desvincular tu cuenta en cualquier momento desde tu perfil.
