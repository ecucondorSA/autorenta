      ...
      <ion-card-content>
        ...
        <div class="coverage-item">
          ...
          <div class="coverage-detail">
            ...
            <p class="coverage-value">Hasta {{ summary.liability_coverage | currency:'ARS':'symbol-narrow':'1.0-0' }}</p>
          </div>
        </div>
        ...
        <div class="coverage-item highlight">
          ...
          <div class="coverage-detail">
            ...
            <p class="coverage-value warning">{{ summary.deductible_amount | currency:'ARS':'symbol-narrow':'1.0-0' }}</p>
          ...
          <div class="addon-list">
            <div class="addon-item-summary" *ngFor="let addon of summary.addons">
              ...
              <div class="addon-info">
                ...
                <span class="addon-cost">{{ addon.total_cost | currency:'ARS':'symbol-narrow':'1.0-0' }}</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="cost-breakdown" *ngIf="summary.total_premium > 0">
          ...
          <div class="cost-row" *ngIf="summary.daily_premium">
            <small>({{ summary.daily_premium | currency:'ARS':'symbol-narrow':'1.0-0' }}/día)</small>
            <span></span>
          </div>
          ...
          <div class="cost-row grand-total" *ngIf="addonsTotalCost > 0">
            ...
            <strong>{{ (summary.total_premium + addonsTotalCost) | currency:'ARS':'symbol-narrow':'1.0-0' }}</strong>
          </div>
        </div>
        ...
        <div class="emergency-info">
          ...
          <div class="emergency-text">
            ...
            <p>Contacta inmediatamente al <a href="tel:0800-AUTORENTAR"><strong>0800-AUTORENTAR</strong></a></p>
