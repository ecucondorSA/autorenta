...
export class SeoFooterComponent {
  ...
  readonly cities: SeoLink[] = [
    ...
    { name: 'Córdoba', slug: 'cordoba', description: 'Centro de Argentina' },
    { name: 'Mendoza', slug: 'mendoza', description: 'Región de Cuyo' },
    ...
    { name: 'Salta', slug: 'salta', description: 'Norte Argentino' },
    { name: 'Santa Fe', slug: 'santa-fe', description: 'Litoral Argentino' },
    { name: 'San Juan', slug: 'san-juan', description: 'Región de Cuyo' },
    { name: 'Resistencia', slug: 'resistencia', description: 'Chaco' },
    { name: 'Corrientes', slug: 'corrientes', description: 'Litoral Argentino' },
    ...
    { name: 'Neuquén', slug: 'neuquen', description: 'Patagonia Norte' },
    { name: 'Formosa', slug: 'formosa', description: 'NEA' },
    { name: 'San Luis', slug: 'san-luis', description: 'Región de Cuyo' },
    {
      name: 'Santiago del Estero',
      slug: 'santiago-del-estero',
      description: 'Santiago del Estero',
    },
    { name: 'La Rioja', slug: 'la-rioja', description: 'NOA' },
    { name: 'Catamarca', slug: 'catamarca', description: 'NOA' },
