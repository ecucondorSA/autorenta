    ...
    Tables: {
      ...
      bookings: {
        Row: {
          ...
          cancelled_by_role: Database['public']['Enums']['booking_cancelled_by_role'] | null;
          car_id: string;
    ...
    Views: {
      ...
      my_bookings: {
        Row: {
          ...
          payment_table_provider: Database['public']['Enums']['payment_provider'] | null;
          payout_date: string | null;
          payout_error_message: string | null;
          payout_retry_count: number | null;
          payout_status: Database['public']['Enums']['payout_status_enum'] | null;
...
export const Constants = {
  public: {
    Enums: {
      ...
      payment_status: ['pending', 'processing', 'approved', 'rejected', 'refunded', 'cancelled'],
      payout_status_enum: ['pending', 'processing', 'completed', 'failed', 'manual_review'],
      subscription_status: ['active', 'inactive', 'depleted', 'expired', 'cancelled', 'upgraded'],
      subscription_tier: ['club_standard', 'club_black', 'club_luxury'],
      ticket_category: [
        'booking_issue',
        'payment_issue',
