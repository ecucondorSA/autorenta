...
export class WalletService {
  ...
  /** @deprecated Use WalletProtectionCreditService.protectionCreditBalance() instead */
  readonly protectedCreditBalance = computed(() => this.balance()?.protected_credit_balance ?? 0);
  /** @deprecated Use WalletProtectionCreditService for non-withdrawable balance operations */
  ...
  // ============================================================================
  // PROTECTION CREDIT METHODS - MOVED TO WalletProtectionCreditService
  // ============================================================================
  // Protection Credit methods have been extracted to a dedicated service
  // as part of Phase 4 refactoring (2025-11-06).
  //
  // Use WalletProtectionCreditService for:
  // - getProtectionCreditBalance()
  // - issueProtectionCredit()
  // - checkProtectionCreditRenewal()
  // - getProtectionCreditFormatted()
  // - getTotalCoverageBalance()
  //
  // This keeps WalletService focused on core wallet operations.
  // ============================================================================
}
