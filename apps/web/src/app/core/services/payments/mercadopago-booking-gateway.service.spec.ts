...
describe('MercadoPagoBookingGatewayService', () => {
  let service: MercadoPagoBookingGatewayService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      providers: [...testProviders, MercadoPagoBookingGatewayService,
        { provide: SupabaseClientService, useValue: mockSupabaseService },],
    });
    service = TestBed.inject(MercadoPagoBookingGatewayService);
  });
  ...
  it('should have isPreferenceValid method', () => {
    expect(typeof service.isPreferenceValid).toBe('function');
  });

  it('should have createBookingPreference method', () => {
    expect(typeof service.createBookingPreference).toBe('function');
  });

  it('should have redirectToCheckout method', () => {
