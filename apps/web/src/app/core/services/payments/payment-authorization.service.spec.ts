...
describe('PaymentAuthorizationService', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      providers: [...testProviders, PaymentAuthorizationService,
        { provide: SupabaseClientService, useValue: mockSupabaseService },],
    });
    service = TestBed.inject(PaymentAuthorizationService);
  });
  ...
  it('should have authorizePayment method', () => {
    expect(typeof service.authorizePayment).toBe('function');
  });

  it('should have getAuthorizationStatus method', () => {
    expect(typeof service.getAuthorizationStatus).toBe('function');
  });

  it('should have captureAuthorization method', () => {
    expect(typeof service.captureAuthorization).toBe('function');
  });

  it('should have cancelAuthorization method', () => {
    expect(typeof service.cancelAuthorization).toBe('function');
  });
});
