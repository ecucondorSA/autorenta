...
describe('CarLocationService', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      providers: [...testProviders, CarLocationService,
        { provide: SupabaseClientService, useValue: mockSupabaseService },],
    });
    service = TestBed.inject(CarLocationService);
  });
  ...
  it('should have getLatestLocations method', () => {
    expect(typeof service.getLatestLocations).toBe('function');
  });
});
