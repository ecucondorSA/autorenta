...
describe('RealtimeConnectionService', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      providers: [...testProviders, RealtimeConnectionService,
  ...
  it('should have getActiveChannelsCount method', () => {
    expect(typeof service.getActiveChannelsCount).toBe('function');
  });

  it('should have isChannelActive method', () => {
    expect(typeof service.isChannelActive).toBe('function');
  });
});
