...
describe('BookingCompletionService', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      providers: [...testProviders, BookingCompletionService,
        { provide: SupabaseClientService, useValue: mockSupabaseService },],
    });
    service = TestBed.inject(BookingCompletionService);
  });
  ...
  it('should have completeBookingClean method', () => {
    expect(typeof service.completeBookingClean).toBe('function');
  });

  it('should have completeBookingWithDamages method', () => {
    expect(typeof service.completeBookingWithDamages).toBe('function');
  });

  it('should have finishBookingWithInspection method', () => {
    expect(typeof service.finishBookingWithInspection).toBe('function');
  });
});
