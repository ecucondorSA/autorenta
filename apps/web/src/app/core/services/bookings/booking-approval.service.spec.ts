...
describe('BookingApprovalService', () => {
  let service: BookingApprovalService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      providers: [BookingApprovalService,
  ...
  it('should have getPendingApprovals method', () => {
    expect(typeof service.getPendingApprovals).toBe('function');
  });

  it('should have approveBooking method', () => {
    expect(typeof service.approveBooking).toBe('function');
  });

  it('should have rejectBooking method', () => {
    expect(typeof service.rejectBooking).toBe('function');
  });

  it('should have carRequiresApproval method', () => {
    expect(typeof service.carRequiresApproval).toBe('function');
  });
