...
describe('BookingValidationService', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      providers: [...testProviders, BookingValidationService,
  ...
  it('should have createBookingWithValidation method', () => {
    expect(typeof service.createBookingWithValidation).toBe('function');
  });

  it('should have validateCancellationTiming method', () => {
    expect(typeof service.validateCancellationTiming).toBe('function');
  });

  it('should have validateCancellationStatus method', () => {
    expect(typeof service.validateCancellationStatus).toBe('function');
  });
});
