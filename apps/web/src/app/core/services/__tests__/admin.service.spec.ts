...
describe('AdminService', () => {
  ...
  describe('isAdmin', () => {
    ...
    it('should return false when user is not admin', async () => {
      mockSupabase.rpc.and.callFake(() => ({
        then: (resolve: any) => resolve({ data: false, error: null }),
  ...
  describe('getAdminRoles', () => {
    it('should return admin roles from RPC', async () => {
      ...
      mockSupabase.rpc.and.callFake(() => ({
        then: (resolve: any) => resolve({ data: mockRoles, error: null }),
        catch: (reject: any) => reject,
      }));
  ...
  describe('logAction', () => {
    it('should log admin action successfully', async () => {
      ...
      mockSupabase.rpc.and.callFake(() => ({
        then: (resolve: any) => resolve({ data: mockLogId, error: null }),
        catch: (reject: any) => reject,
      }));
    ...
    it('should include IP and user agent if provided', async () => {
      mockSupabase.rpc.and.callFake(() => ({
        then: (resolve: any) => resolve({ data: 'log-id', error: null }),
        catch: (reject: any) => reject,
      }));
