...
describe('AdminService', () => {
  ...
  beforeEach(() => {
    ...
    // Setup rpc mock to return a Promise (services now return Promises, not PostgrestFilterBuilder)
    mockSupabase.rpc.and.callFake(() => Promise.resolve({ data: true, error: null }));
  });
  ...
  describe('isAdmin', () => {
    ...
    it('should return false when user is not admin', async () => {
      mockSupabase.rpc.and.callFake(() => Promise.resolve({ data: false, error: null }));
  ...
  describe('getAdminRoles', () => {
    it('should return admin roles from RPC', async () => {
      ...
      mockSupabase.rpc.and.callFake(() => Promise.resolve({ data: mockRoles, error: null }));
  ...
  describe('logAction', () => {
    it('should log admin action successfully', async () => {
      ...
      mockSupabase.rpc.and.callFake(() => Promise.resolve({ data: mockLogId, error: null }));
    ...
    it('should include IP and user agent if provided', async () => {
      mockSupabase.rpc.and.callFake(() => Promise.resolve({ data: 'log-id', error: null }));
