...
import { CarDepreciationNotificationsService } from '@core/services/cars/car-depreciation-notifications.service';
...
describe('CarDepreciationNotificationsService', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      providers: [...testProviders, CarDepreciationNotificationsService,
