...
import { CarLocationsService } from '@core/services/geo/car-locations.service';
...
describe('CarLocationsService', () => {
  let service: CarLocationsService;
  ...
  beforeEach(() => {
    ...
    service = TestBed.inject(CarLocationsService);
  });
  ...
  it('should have fetchActiveLocations method', () => {
    expect(typeof service.fetchActiveLocations).toBe('function');
  });

  it('should have getReviewCount method', () => {
    expect(typeof service.getReviewCount).toBe('function');
  });

  it('should have getReviewCountsBatch method', () => {
    expect(typeof service.getReviewCountsBatch).toBe('function');
  });

  it('should have getRefreshInterval method', () => {
    expect(typeof service.getRefreshInterval).toBe('function');
  });

  it('should have clearReviewsCache method', () => {
    expect(typeof service.clearReviewsCache).toBe('function');
  });
