-- ============================================================================
-- FIX: get_available_cars - Corrected for actual schema
-- Date: 2026-02-03
-- Applied to production aceacpaockyxgogxsfyc
-- ============================================================================
...
BEGIN
    ...
    SELECT
        c.id,
        c.owner_id,
        COALESCE(c.brand, c.ai_recognized_brand, 'Unknown')::TEXT as brand,
        COALESCE(c.model, c.ai_recognized_model, 'Unknown')::TEXT as model,
        c.year,
        ''::TEXT as plate,
