-- ============================================================================
-- FIX: get_available_cars - Force replace with correct lat/lng
-- Date: 2026-02-04
-- Issue: Previous CREATE OR REPLACE didn't update cached function
-- ============================================================================

-- Drop ALL overloads of get_available_cars to ensure clean slate
...
-- Recreate with correct lat/lng fields
...
-- Grant permissions
GRANT EXECUTE ON FUNCTION public.get_available_cars TO anon, authenticated;

-- Force PostgREST schema reload
NOTIFY pgrst, 'reload schema';

COMMENT ON FUNCTION public.get_available_cars IS 'Returns available cars with location coordinates (lat/lng) for map display. Fixed 2026-02-04.';
