-- ============================================================================
-- Add renter verification snapshot for owners + extra license fields
-- ============================================================================

-- Extend document_kind enum for criminal record (antecedentes penales)
ALTER TYPE document_kind ADD VALUE IF NOT EXISTS 'criminal_record';

-- Add driver license details to profiles
ALTER TABLE profiles
  ADD COLUMN IF NOT EXISTS driver_license_class text,
  ADD COLUMN IF NOT EXISTS driver_license_professional boolean,
  ADD COLUMN IF NOT EXISTS driver_license_points integer;

-- RPC: get renter verification snapshot for owner by booking
