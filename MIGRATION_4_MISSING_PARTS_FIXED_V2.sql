-- ============================================================================
-- PII ENCRYPTION - Migration 4 MISSING PARTS (FIXED V2 - WITH DROPS)
-- ============================================================================
-- Execute this in Supabase SQL Editor to complete Migration 4
-- Missing: bank_accounts_decrypted view + 3 RPC functions
--
-- V2 CHANGES: Added DROP FUNCTION statements before CREATE to avoid conflicts
-- ============================================================================

BEGIN;

-- ============================================================================
-- PART 1: Create bank_accounts_decrypted view
-- ============================================================================
...
-- ============================================================================
-- PART 2: update_profile_with_encryption
-- ============================================================================

-- DROP existing function if it exists (handles signature changes)
DROP FUNCTION IF EXISTS update_profile_with_encryption(UUID, JSONB);
...
-- ============================================================================
-- PART 3: add_bank_account_with_encryption
-- ============================================================================

-- DROP existing function if it exists (handles signature changes)
DROP FUNCTION IF EXISTS add_bank_account_with_encryption(TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT);
DROP FUNCTION IF EXISTS add_bank_account_with_encryption(TEXT, TEXT, TEXT, TEXT, TEXT);
...
CREATE OR REPLACE FUNCTION add_bank_account_with_encryption(
  ...
  p_account_holder_id TEXT DEFAULT NULL
)
RETURNS UUID AS $$
DECLARE
  v_account_id UUID;
...
-- ============================================================================
-- PART 4: get_my_profile_decrypted
-- ============================================================================

-- DROP existing function if it exists (handles return type changes)
DROP FUNCTION IF EXISTS get_my_profile_decrypted();
...
-- ============================================================================
-- V2 CHANGES:
-- ✅ Added DROP FUNCTION statements before CREATE for all 3 functions
-- ✅ This handles signature/return type changes gracefully
