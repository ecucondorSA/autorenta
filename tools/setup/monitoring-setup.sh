...
SELECT cron.schedule(
    ...
    SELECT
        net.http_post(
            url := 'https://aceacpaockyxgogxsfyc.supabase.co/functions/v1/monitoring-health-check',
...
SELECT cron.schedule(
    ...
    SELECT
        net.http_post(
            url := 'https://aceacpaockyxgogxsfyc.supabase.co/functions/v1/monitoring-alerts',
            headers := jsonb_build_object(
                'Content-Type', 'application/json',
                'Authorization', 'Bearer ' || current_setting('app.settings.service_role_key')
            ),
...
HEALTH_CHECK_URL="https://aceacpaockyxgogxsfyc.supabase.co/functions/v1/monitoring-health-check"
...
METRICS_URL="https://aceacpaockyxgogxsfyc.supabase.co/functions/v1/monitoring-metrics?action=summary"
...
echo "     https://aceacpaockyxgogxsfyc.supabase.co/functions/v1/monitoring-metrics?action=summary"
echo ""
echo "  2. View active alerts:"
echo "     https://aceacpaockyxgogxsfyc.supabase.co/functions/v1/monitoring-metrics?action=active_alerts"
echo ""
